...
// ───────────────────────────────────────────────────────────────
export default function TabletControlMendoza({ sessionId, playerName, playerIndex, matchToken }) {
                      ...
                      return (
                        <button
                          ...
                          className={`flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-white/10 rounded-lg border-2 active:scale-95 touch-manipulation overflow-hidden relative ${
                            clickedItemId === charId ? 'border-green-400 shadow-green-500/30' : ''
                          }`}
              ...
              session.winnerProposal && myPlayer && session.winnerProposal.proposedBy !== myPlayer ? (
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="py-4 sm:py-5 rounded-xl font-black text-base sm:text-lg text-white active:scale-95 transition-all shadow-2xl border-2 touch-manipulation"
                    style={{ background: `linear-gradient(135deg, ${THEME.colors.primary}80, ${THEME.colors.primary}60)`, borderColor: `${THEME.colors.primary}80` }}
                  >
                    🏆<br />
                  ...
                  <button
                    ...
                    className="py-4 sm:py-5 rounded-xl font-black text-base sm:text-lg text-white active:scale-95 transition-all shadow-2xl border-2 touch-manipulation"
                    style={{ background: `linear-gradient(135deg, ${THEME.colors.secondary}80, ${THEME.colors.secondary}60)`, borderColor: `${THEME.colors.secondary}80` }}
                  >
                    🏆<br />
