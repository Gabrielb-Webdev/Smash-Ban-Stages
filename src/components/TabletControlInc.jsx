...
export default function TabletControlInc({ sessionId, playerName, playerIndex, matchToken }) {
  ...
  if (!sessionId) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: INC_BG, fontFamily: 'Anton, sans-serif', minHeight: '100dvh' }}>
  ...
  if (error && error === 'Sesión no encontrada') {
    return (
      <div className="min-h-screen flex items-center justify-center p-4" style={{ background: INC_BG, fontFamily: 'Anton, sans-serif', minHeight: '100dvh' }}>
  ...
  // ── Render ──────────────────────────────────────────────────
  return (
    <div style={{ background: INC_BG, fontFamily: 'Anton, sans-serif', minHeight: '100dvh' }}>
        ...
        <div className="flex justify-between items-center gap-2">
          <div className="flex items-center gap-2 flex-1">
            ...
            <div className="flex-shrink-0 flex flex-col items-center gap-0.5">
              <img src="/images/inc.png" alt="INC" style={{ width: 32, height: 32, objectFit: 'contain', opacity: 0.9 }} />
              ...
              {session.currentGame === 1 ? (
                ...
                <>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-1.5 sm:gap-2">
                    {GAME1_STAGES_INC.slice(0, 3).map(s => (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-6 gap-1.5 sm:gap-2">
                    ...
                    {GAME1_STAGES_INC.slice(3, 5).map(s => (
                  ...
                  <div className="flex gap-1.5 sm:gap-2 overflow-x-auto pb-1" style={{ scrollbarWidth: 'none' }}>
                    {playerPickHistory.map((charId) => {
                      ...
                      return (
                        ...
                        >
                          <img src={char.image} alt={char.name} className="w-full h-full object-contain" onError={(e) => { e.target.style.display='none'; }} />
                        </button>
                      );
                    })}
                  </div>
