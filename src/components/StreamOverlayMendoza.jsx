// ============================================================
// STREAM OVERLAY - AFK MENDOZA (Team Anexo)
...
export default function StreamOverlayMendoza({ sessionId }) {
  const { session, connected } = useWebSocket(sessionId);
  const error = !connected ? 'Desconectado del servidor' : null;

  // Ref para controlar velocidad del video de fondo
