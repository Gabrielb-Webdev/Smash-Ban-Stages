// GET  /api/osu/score-state  → estado actual del scoreboard (público, para OBS / overlays)
// POST /api/osu/score-state  → actualizar estado (desde control.html)

import redis from '../../../lib/redis';

const STATE_KEY = 'osu:score:state';
