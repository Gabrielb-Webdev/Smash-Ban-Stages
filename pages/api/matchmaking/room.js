      ...
      if (allAccepted) {
        if (is2v2) {
          ...
          const matchRecord = {
            ...
            format:   'bo3',
            stage:    null,
            player1:  { userId: room.host.userId,  userName: room.host.userName,  charId: room.host.charId  || null, charAlt: room.host.charAlt  || null },
            player2:  { userId: room.guest.userId, userName: room.guest.userName, charId: room.guest.charId || null, charAlt: room.guest.charAlt || null },
            status:   'banning',
            games:    [],
            currentGame: 1,
