...
const STAGE_IMG = {
  ...
  'PokÃ©mon Stadium 2': '/images/stages/Pokemon%20Stadium%202.png',
...
/* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ PLATAFORMAS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
const PLATFORMS = [
  { id: 'parsec',  label: 'Parsec',        icon: 'ðŸ–¥ï¸', from: '#7C3AED', to: '#3730A3' },
  { id: 'switch',  label: 'Switch Online', icon: 'ðŸŽ®', from: '#DC2626', to: '#9F1239' },
];

/* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ SVG HELPERS Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
...
/* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ ROOT Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
const COUNTRY_TO_CODE = {
  'Argentina':'AR','Brasil':'BR','Brazil':'BR','Mexico':'MX','MÃ©xico':'MX',
  'Chile':'CL','Peru':'PE','PerÃº':'PE','Colombia':'CO','Venezuela':'VE',
  'Uruguay':'UY','Paraguay':'PY','Bolivia':'BO','Ecuador':'EC','Costa Rica':'CR',
  'United States':'US','USA':'US','Canada':'CA','Spain':'ES','EspaÃ±a':'ES',
...
function getNotifRoute(notif) {
  ...
  // call_to_play or unknown â†’ match tab, or external url if provided
  const url = notif?.url || '';
...
const TOUR_STEPS = [
  {
    ...
    emoji: 'ðŸ‘¤',
    title: 'Tu perfil',
    desc: 'AcÃ¡ ves tu rango ranked 1v1 y 2v2, tu personaje principal, historial de partidas y tus estadÃ­sticas generales. TambiÃ©n podÃ©s cambiar tu main desde acÃ¡.',
  },
  {
    tab: 'match',
    emoji: 'âš”ï¸',
    title: 'Ranked â€“ Buscar partida',
    desc: 'El botÃ³n central te manda a la cola de matchmaking. Te emparejamos con jugadores de rango similar; al terminar, tu rango, RR y MMR se actualizan segÃºn el resultado y los stocks con que ganaste.',
  },
  {
    tab: 'rankings',
    emoji: 'ðŸ†',
    title: 'Rankings',
    desc: 'El leaderboard de todos los jugadores, ordenado por rango. Los rankeados van primero (el de mayor tier y puntos arriba); los que aÃºn estÃ¡n en sus 10 partidas de clasificatoria aparecen al fondo, ordenados por victorias.',
  },
  {
    tab: 'torneos',
    emoji: 'ðŸ“…',
    title: 'Torneos',
    desc: 'Los torneos activos de la comunidad. PodÃ©s inscribirte, seguir el bracket en tiempo real y ver tus partidas pendientes sin salir de la app.',
  },
  {
    tab: 'tips',
    emoji: 'ðŸ’¡',
    title: 'Tips',
    desc: 'Consejos y guÃ­as de la comunidad para mejorar tu juego. ðŸŽ® DaÃ©le una mirada cuando quieras subir de rango mÃ¡s rÃ¡pido.',
  },
];
...
export default function HomePage() {
  ...
  const [showIconUpdateBanner, setShowIconUpdateBanner] = useState(false); // iOS standalone: actualizar Ã­cono
  ...
  useEffect(() => {
    ...
    // Limpiar localStorage per-user si cambiÃ³ el usuario (otra cuenta en el mismo dispositivo)
    try {
    ...
    // Refrescar adminCommunities desde el servidor (para community admins aÃ±adidos despuÃ©s del login)
  ...
  // Polling de notificaciones â€” eliminado, ahora vienen en el heartbeat
  // y en tiempo real vÃ­a WebSocket (new-notification)
  ...
  const registerPush = async (uid, userName) => {
    ...
    try {
      ...
      // Si ya hay una suscripciÃ³n con otra key, desuscribir primero
      const existingSub = await reg.pushManager.getSubscription();
      if (existingSub) {
        await existingSub.unsubscribe();
        console.log('[PUSH] SuscripciÃ³n anterior eliminada');
      }
  ...
  useEffect(() => {
    ...
    // Por eso mostramos un botÃ³n en lugar de llamarlo automÃ¡ticamente
    if (isIOS && isStandalone) {
      // Solo mostrar el botÃ³n si aÃºn no tiene permiso
      if (Notification.permission !== 'granted') {
        setShowIOSPushBtn(true);
      } else {
        // Ya tiene permiso: re-registrar la suscripciÃ³n silenciosamente
    ...
    if (Notification.permission === 'granted') {
      ...
      // 'default' (no preguntado aÃºn): mostrar banner para solicitar con gesto explÃ­cito
      setShowPushBanner(true);
    }
  }, [user]);
  ...
  // Detectar sala activa al cargar la app Y polling mientras estÃ¡ idle (cada 8s)
  // AsÃ­ detecta matches creados remotamente sin necesidad de F5
  useEffect(() => {
    if (!user || bgMM) return;
    const uid = String(user?.id || user?.slug || '');
    if (!uid) return;
  ...
  // Countdown local para la pantalla de aceptaciÃ³n
  useEffect(() => {
  ...
  // Deep link desde notificaciÃ³n push: /home?open=tab
  useEffect(() => {
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', height: '100dvh', background: '#0B0B12', display: 'flex', flexDirection: 'column', position: 'relative', overflow: 'hidden' }}>
        ...
        {showInstallBanner && (
          <div style={{ background: 'linear-gradient(135deg,rgba(255,140,0,0.13),rgba(232,93,0,0.08))', border: '1px solid rgba(255,140,0,0.35)', margin: '10px 12px 0', borderRadius: 16, padding: '12px 14px', display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ width: 42, height: 42, borderRadius: 12, background: 'linear-gradient(135deg,#FF8C00,#E85D00)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22, flexShrink: 0 }}>ðŸ“²</div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ margin: 0, fontSize: 13, fontWeight: 800, color: '#FF8C00', letterSpacing: '-0.2px' }}>InstalÃ¡ La app sin H</p>
              <p style={{ margin: '2px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.5)', lineHeight: 1.4 }}>Acceso rÃ¡pido desde tu pantalla de inicio, sin navegador.</p>
            </div>
            <div style={{ display: 'flex', gap: 6, flexShrink: 0 }}>
              ...
              >Instalar</button>
              <button onClick={dismissInstall} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.28)', fontSize: 20, cursor: 'pointer', padding: '0 4px' }}>âœ•</button>
            </div>
          </div>
        )}
        {/* iOS Standalone: botÃ³n para activar notificaciones (debe ser gesto del usuario) */}
        {showIOSPushBtn && (
          <div style={{ background: 'rgba(124,58,237,0.10)', border: '1px solid rgba(124,58,237,0.28)', margin: '10px 12px 0', borderRadius: 16, padding: '12px 14px', display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ width: 40, height: 40, borderRadius: 11, background: 'linear-gradient(135deg,#7C3AED,#5B21B6)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>ðŸ””</div>
            <div style={{ flex: 1 }}>
              <p style={{ margin: 0, fontSize: 13, fontWeight: 800, color: '#A78BFA' }}>Activar notificaciones</p>
              <p style={{ margin: '2px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.45)' }}>RecibÃ­ alertas cuando te llamen a jugar</p>
            </div>
            <button
              onClick={async () => {
            ...
            >
              {iosPushState === 'loading' ? '...' : iosPushState === 'error' ? 'âŒ Error' : 'Activar'}
            </button>
            <button onClick={() => setShowIOSPushBtn(false)} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.28)', fontSize: 20, cursor: 'pointer', padding: '0 4px', flexShrink: 0 }}>âœ•</button>
          </div>
        )}
        ...
        {showPushBanner && (
          <div style={{ background: pushBannerState === 'denied' ? 'rgba(239,68,68,0.08)' : 'rgba(124,58,237,0.10)', border: `1px solid ${pushBannerState === 'denied' ? 'rgba(239,68,68,0.25)' : 'rgba(124,58,237,0.28)'}`, margin: '10px 12px 0', borderRadius: 16, padding: '12px 14px', display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ width: 40, height: 40, borderRadius: 11, background: pushBannerState === 'denied' ? 'linear-gradient(135deg,#EF4444,#B91C1C)' : 'linear-gradient(135deg,#7C3AED,#5B21B6)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>ðŸ””</div>
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <p style={{ margin: '2px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.45)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {pushBannerState === 'denied'
                  ? 'Habilitalo en los ajustes del sitio (ðŸ”’ en la barra de URL)'
                  : 'RecibÃ­ alertas cuando te llamen a jugar'}
              </p>
            </div>
            {pushBannerState !== 'denied' && (
              <button
              ...
              >
                {pushBannerState === 'loading' ? '...' : pushBannerState === 'error' ? 'âŒ Reintentar' : 'Activar'}
              </button>
            )}
            <button onClick={() => setShowPushBanner(false)} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.28)', fontSize: 20, cursor: 'pointer', padding: '0 4px', flexShrink: 0 }}>âœ•</button>
          </div>
        )}
        ...
        {activeTournamentMatch && (
          <div
            ...
            <div style={{ width: 42, height: 42, borderRadius: 12, background: activeTournamentMatch.phase === 'CHECKIN' ? 'linear-gradient(135deg,#EF4444,#B91C1C)' : 'linear-gradient(135deg,#22C55E,#16A34A)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>
              {activeTournamentMatch.phase === 'CHECKIN' ? 'ðŸ””' : 'âš”ï¸'}
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ margin: 0, fontSize: 13, fontWeight: 900, color: activeTournamentMatch.phase === 'CHECKIN' ? '#F87171' : '#4ADE80' }}>
                {activeTournamentMatch.phase === 'CHECKIN' ? 'Â¡HacÃ© check-in en tu match!' : 'Â¡TenÃ©s un match activo!'}
              </p>
              ...
              {activeTournamentMatch.sessionId && (() => {
                ...
                const label = sid.includes('stream') ? 'ðŸ“¡ Stream' : (() => { const m = sid.match(/-(\d+)-/); return m ? `ðŸŽ® Setup ${m[1]}` : null; })();
            ...
            <span style={{ fontSize: 14, color: 'rgba(255,255,255,0.35)', flexShrink: 0 }}>â¯</span>
          </div>
        )}
        ...
        {showIOSTip && (
          <div style={{ background: 'rgba(232,142,0,0.10)', border: '1px solid rgba(232,142,0,0.28)', margin: '10px 12px 0', borderRadius: 16, padding: '12px 14px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
              <div style={{ width: 40, height: 40, borderRadius: 11, background: 'linear-gradient(135deg,#FF8C00,#E85D00)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>ðŸ“²</div>
              <div style={{ flex: 1 }}>
                <p style={{ margin: 0, fontSize: 13, fontWeight: 800, color: '#FF8C00' }}>InstalÃ¡ La app sin H en iPhone</p>
                <p style={{ margin: '1px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.45)' }}>SeguÃ­ estos 3 pasos rÃ¡pidos</p>
              </div>
              <button onClick={() => setShowIOSTip(false)} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.28)', fontSize: 20, cursor: 'pointer', padding: '0 4px', flexShrink: 0 }}>âœ•</button>
            </div>
            <div style={{ display: 'flex', gap: 8 }}>
              {[
                { icon: 'âŽ‹', label: 'TocÃ¡ el botÃ³n', desc: 'Compartir (cuadrado con flecha)' },
                { icon: 'ï¼‹', label: 'ElegÃ­', desc: '"Agregar a pantalla de inicio"' },
                { icon: 'âœ“', label: 'ConfirmÃ¡', desc: 'TocÃ¡ "Agregar" arriba a la derecha' },
              ].map((s, i) => (
        ...
        {/* iOS Standalone: actualizar Ã­cono de la app */}
        {showIconUpdateBanner && (
          <div style={{ background: 'rgba(232,142,0,0.10)', border: '1px solid rgba(232,142,0,0.28)', margin: '10px 12px 0', borderRadius: 16, padding: '12px 14px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 10 }}>
              <img src="/images/logo.app.png" alt="Nuevo Ã­cono" style={{ width: 40, height: 40, borderRadius: 11, background: '#000', flexShrink: 0 }} />
              <div style={{ flex: 1 }}>
                <p style={{ margin: 0, fontSize: 13, fontWeight: 800, color: '#FF8C00' }}>Â¡Nuevo Ã­cono disponible!</p>
                <p style={{ margin: '1px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.45)', lineHeight: 1.4 }}>Para actualizar el Ã­cono en tu pantalla de inicio, borrÃ¡ la app y volvÃ© a agregarla desde Safari.</p>
              </div>
              <button
                onClick={() => {
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              {[
                { icon: 'ðŸ—‘ï¸', label: 'BorrÃ¡ la app', desc: 'MantenÃ© presionado el Ã­cono y eliminÃ¡' },
                { icon: 'ðŸŒ', label: 'AbrÃ­ Safari', desc: 'EntrÃ¡ a la app desde el navegador' },
                { icon: 'ï¼‹', label: 'AgregÃ¡ de nuevo', desc: 'Compartir â†’ "Agregar a pantalla de inicio"' },
              ].map((s, i) => (
                <div key={i} style={{ flex: 1, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 11, padding: '8px 7px', textAlign: 'center' }}>
                  <div style={{ width: 28, height: 28, borderRadius: 8, background: 'rgba(255,140,0,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 15, margin: '0 auto 5px' }}>{s.icon}</div>
                  <p style={{ margin: '0 0 2px', fontSize: 10, fontWeight: 800, color: '#FF8C00' }}>{s.label}</p>
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ PROFILE MENU OVERLAY Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {showMenu && (
          <>
            ...
            <div style={{
              ...
              {(isAdmin || adminCommunities.length > 0) && (() => {
                ...
                return _panelItems.map(item => (
                  <div key={item.url} style={{ padding: '8px 10px 4px' }}>
                    ...
                    >
                      <div style={{ width: 38, height: 38, borderRadius: 13, background: 'rgba(232,142,0,0.14)', border: '1px solid rgba(232,142,0,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 17, flexShrink: 0 }}>ðŸŽ›ï¸</div>
                      <div style={{ flex: 1 }}>
              ...
              <div style={{ padding: '4px 10px 0' }}>
                <button onClick={() => { setShowMenu(false); setTab('amigos'); }}
                  ...
                  onMouseLeave={e => e.currentTarget.style.background = 'transparent'}
                >
                  <div style={{ width: 38, height: 38, borderRadius: 13, background: 'rgba(99,102,241,0.14)', border: '1px solid rgba(99,102,241,0.25)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 17, flexShrink: 0 }}>ðŸ‘¥</div>
                  <div style={{ flex: 1 }}>
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ NOTIFICATION DRAWER Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {showNotifs && (
          <>
            ...
            <div style={{
              ...
              {/* â”€â”€ Sticky header: handle + tÃ­tulo (no hace scroll) â”€â”€ */}
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14, paddingBottom: 14, borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
                  ...
                  {unreadCount > 0 && (
                    <button onClick={dismissAllNotifs} style={{ background: 'rgba(99,102,241,0.12)', border: '1px solid rgba(99,102,241,0.3)', borderRadius: 8, padding: '5px 12px', cursor: 'pointer' }}>
                      <span style={{ fontSize: 11, fontWeight: 700, color: '#818CF8' }}>Marcar todas como leÃ­das</span>
                    </button>
                  )}
                </div>
              </div>
              {/* â”€â”€ Ãrea scrolleable â”€â”€ */}
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 700, color: '#fff' }}>
                  {bgMM.status === 'searching'       ? 'Buscando partida...'     :
                   bgMM.status === 'waiting'          ? 'Esperando confirmaciÃ³n'  :
                   bgMM.status === 'active'           ? 'Â¡Partida en juego!'      :
              ...
              <>
                ...
                <div style={{
                  ...
                  <div style={{ padding: '16px 18px 12px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <span style={{ fontWeight: 900, fontSize: 15, color: '#fff' }}>ðŸ’¬ Chats</span>
                    <button onClick={() => { setChatBubbleOpen(false); setTab('amigos'); }} style={{ background: 'none', border: 'none', color: '#6366F1', fontSize: 12, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}>Ver todos â†’</button>
                  </div>
          ...
          <div style={{
            ...
            <div ref={miniChatScrollRef} style={{ flex: 1, overflowY: 'auto', padding: '12px 14px', display: 'flex', flexDirection: 'column', gap: 6 }}>
              ...
              {miniChatMsgs.length === 0 && (
                <p style={{ textAlign: 'center', color: 'rgba(255,255,255,0.2)', fontSize: 12, marginTop: 20 }}>No hay mensajes aÃºn</p>
              )}
            </div>
            {/* Input */}
        ...
        {/* â•â• POPUP match encontrado â•â• */}
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: 20 }}>
                  <div style={{ fontSize: 46, marginBottom: 10 }}>âš¡</div>
                  <p style={{ margin: '0 0 4px', fontSize: 22, fontWeight: 900, color: '#fff' }}>Â¡Partida encontrada!</p>
                  <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.35)' }}>{is2v2 ? '2v2 Â· ' : ''}{pData?.label ?? bgMM.plat}</p>
                </div>
                <div style={{
                  ...
                  {is2v2 ? (
                    ...
                    <p style={{ margin: 0, fontSize: 20, fontWeight: 900, color: '#fff' }}>{opponent?.userName || 'â€”'}</p>
                  )}
                </div>
                ...
                {(() => {
                  ...
                  return (
                    <div style={{ display: 'flex', gap: 10 }}>
                      ...
                      }}>{iDidAccept ? 'âœ… Aceptado â€” Esperando rivalâ€¦' : 'âœ… Aceptar'}</button>
                    </div>
                  );
                })()}
              </div>
      ...
      {showTour && (() => {
        ...
        return (
          <div style={{ position: 'fixed', inset: 0, zIndex: 9998 }}>
            {/* Backdrop semitransparente â€” no bloquea interacciÃ³n con la app */}
...
/* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ BOTTOM NAV Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
...
/* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ SECTION HEADER Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
...
/* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ STAT CARD Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
...
/* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ TAG Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
      ...
      {!isTop3 && !inPlacement && (
        <div style={{ textAlign: 'right', flexShrink: 0, paddingRight: charSrc ? 4 : 14 }}>
          <p style={{ margin: 0, fontSize: 12, fontWeight: 800 }}>
            ...
            <span style={{ color: 'rgba(255,255,255,0.2)', margin: '0 3px' }}>Â·</span>
...
function TabInicio({ user, isAdmin, router, displayName, initial, setTab }) {
  ...
  return (
    <div style={{ paddingBottom: 28 }}>
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ Greeting row Ã¢â€â‚¬Ã¢â€â‚¬ */}
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ Featured Banner Ã¢â€â‚¬Ã¢â€â‚¬ */}
      ...
      {/* Ã¢â€â‚¬Ã¢â€â‚¬ Quick access pills Ã¢â€â‚¬Ã¢â€â‚¬ */}
      ...
      <div style={{ padding: '0 16px' }}>
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Quick Match CTA Ã¢â€â‚¬Ã¢â€â‚¬ */}
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Admin button Ã¢â€â‚¬Ã¢â€â‚¬ */}
        {isAdmin && (
        ...
        {/* Ã¢â€â‚¬Ã¢â€â‚¬ Comunidades Ã¢â€â‚¬Ã¢â€â‚¬ */}
...
function MatchDetail({ match: m, viewingId, onClose }) {
  ...
  const CharIcon = ({ src }) => (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
      {src ? <img src={src} alt="" style={{ width: 52, height: 52, objectFit: 'contain' }} onError={e => { e.target.style.display='none'; }} /> : <div style={{ width: 52, height: 52, borderRadius: 12, background: 'rgba(255,255,255,0.07)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>âš”ï¸</div>}
    </div>
  );
  return (
    <div style={{ position: 'fixed', inset: 0, background: '#0A0A12', zIndex: 10001, display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '12px 16px', background: '#0D0D18', borderBottom: '1px solid rgba(255,255,255,0.06)', position: 'sticky', top: 0, zIndex: 10 }}>
        <button onClick={onClose} style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 10, width: 36, height: 36, color: '#fff', cursor: 'pointer', fontSize: 18, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>â†</button>
      ...
      <div style={{ maxWidth: 480, margin: '0 auto', width: '100%', padding: '16px' }}>
        ...
        <div style={{ background: isWin ? 'rgba(34,197,94,0.06)' : 'rgba(239,68,68,0.06)', border: `1px solid ${isWin ? 'rgba(34,197,94,0.2)' : 'rgba(239,68,68,0.2)'}`, borderRadius: 20, padding: '20px 16px', marginBottom: 14, display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
            {myScore != null && <p style={{ margin: 0, fontSize: 30, fontWeight: 900, color: '#fff', letterSpacing: 2 }}>{myScore}â€“{oppScore ?? 0}</p>}
        ...
        <p style={{ margin: '0 0 14px', fontSize: 11, color: 'rgba(255,255,255,0.35)', fontWeight: 600 }}>{platLabel(m.platform)} Â· {timeAgo(m.playedAt)}{isCasual ? ' Â· Normal' : is2v2 ? ' Â· 2v2' : ' Â· Ranked'}</p>
        {/* Juegos */}
        ...
        {games.length > 0 ? (
                ...
                <div key={gi} style={{ position: 'relative', height: 80, borderRadius: 14, overflow: 'hidden', borderLeft: `3px solid ${gWon ? '#22C55E' : '#EF4444'}` }}>
                  ...
                  <div style={{ position: 'relative', display: 'flex', alignItems: 'center', height: '100%', padding: '0 14px' }}>
                    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 3 }}>
                      ...
                      {gStocks != null && <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.45)' }}>{gWon ? `Ganaste Â· ${gStocks} stock${gStocks !== 1 ? 's' : ''}` : `Perdiste Â· ${gStocks} stock${gStocks !== 1 ? 's' : ''}`}</p>}
                    </div>
                    <p style={{ margin: 0, fontSize: 18, fontWeight: 900, color: gWon ? '#22C55E' : '#EF4444', flexShrink: 0 }}>{gWon ? 'âœ“' : 'âœ—'}</p>
                  </div>
                </div>
              );
            })}
          ...
          <div style={{ background: 'rgba(255,255,255,0.03)', borderRadius: 14, padding: '24px 16px', textAlign: 'center' }}>
            <p style={{ margin: 0, fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>{isCasual ? 'Las partidas normales son BO1 â€” sin detalle por juego' : 'Sin detalle de juegos disponible para esta partida'}</p>
          </div>
        )}
      </div>
    </div>
...
function TabAmigos({ user }) {
  ...
  useEffect(() => {
    if (!uid) return;
    // Callback: cuando un amigo cambia de estado â†’ actualizar campo 'online' (que usa la UI)
    setPresenceCallback(({ userId, status }) => {
      setFriends(prev => prev.map(f =>
        String(f.userId) === String(userId) ? { ...f, online: status } : f
      ));
    });
    // Callback: notificaciÃ³n en tiempo real
    ...
    // Callback: socket reconectÃ³ â†’ re-sincronizar estados de amigos desde la API
    // (cubre eventos perdidos durante la desconexiÃ³n)
  ...
  // Polling de estados de amigos cada 30s â€” fallback para cambios que no emiten evento WS
  ...
  useEffect(() => {
    ...
    return () => clearInterval(iv);
  // Solo reiniciar si uid cambia o si la lista pasa de vacÃ­a a con amigos
  // eslint-disable-next-line react-hooks/exhaustive-deps
  ...
  const renderFriendRow = (f, statusColor, statusLabel) => {
    ...
    <div key={f.userId} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 16px', background: isOffline ? 'transparent' : 'rgba(255,255,255,0.02)', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
      ...
      <button onClick={() => { setChatOpen({ userId: f.userId, userName: f.userName }); setChatMessages([]); }} style={{ padding: '6px 12px', borderRadius: 8, border: '1px solid rgba(99,102,241,0.25)', background: 'rgba(99,102,241,0.12)', color: '#818CF8', fontWeight: 700, fontSize: 12, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4 }}>
        <span>ðŸ’¬</span><span style={{ fontSize: 10 }}>Chat</span>
      </button>
      <button onClick={() => removeFriend(f.userId)} style={{ padding: '6px 8px', borderRadius: 8, border: '1px solid rgba(239,68,68,0.15)', background: 'rgba(239,68,68,0.06)', color: 'rgba(239,68,68,0.5)', fontWeight: 700, fontSize: 12, cursor: 'pointer' }}>âœ•</button>
    </div>
    );
  };
  ...
  const renderGroup = (label, icon, color, items, groupKey) => {
    ...
    const statusMap = { in_match: { color: '#34D399', label: 'En partida' }, searching: { color: '#FBBF24', label: 'Buscandoâ€¦' }, online: { color: '#22C55E', label: 'En lÃ­nea' }, away: { color: '#F59E0B', label: 'Ausente' }, dnd: { color: '#EF4444', label: 'No molestar' }, offline: { color: null, label: 'Desconectado' } };
    ...
    return (
      <div>
        <button onClick={() => setFriendCollapsed(p => ({ ...p, [groupKey]: !p[groupKey] }))} style={{ width: '100%', display: 'flex', alignItems: 'center', gap: 8, padding: '10px 16px', background: color ? `${color}0D` : 'transparent', border: 'none', borderBottom: '1px solid rgba(255,255,255,0.04)', cursor: 'pointer' }}>
          ...
          <span style={{ fontSize: 10, color: 'rgba(255,255,255,0.2)', transform: friendCollapsed[groupKey] ? 'rotate(-90deg)' : 'rotate(0)', transition: 'transform 0.15s' }}>â–¼</span>
        </button>
  ...
  return (
    <div style={{ paddingBottom: 32 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ margin: '2px 0 0', fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>
              ...
              {friends.filter(f => f.online && f.online !== 'offline').length > 0 && (
                <span style={{ color: '#22C55E', fontWeight: 700 }}> Â· {friends.filter(f => f.online && f.online !== 'offline').length} en lÃ­nea</span>
              )}
            </p>
          </div>
          {/* My status selector */}
          <div style={{ position: 'relative' }}>
            <button onClick={() => setShowStatusMenu(p => !p)} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', borderRadius: 10, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.05)', cursor: 'pointer' }}>
              ...
              <span style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.6)' }}>
                {myStatus === 'online' ? 'En lÃ­nea' : myStatus === 'away' ? 'Ausente' : myStatus === 'dnd' ? 'No molestar' : 'Invisible'}
              </span>
              <span style={{ fontSize: 8, color: 'rgba(255,255,255,0.3)' }}>â–¼</span>
            </button>
            {showStatusMenu && (
              <div style={{ position: 'absolute', top: '100%', right: 0, marginTop: 4, background: '#1A1A2E', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 12, overflow: 'hidden', zIndex: 50, minWidth: 150, boxShadow: '0 8px 24px rgba(0,0,0,0.5)' }}>
                {[
                  { key: 'online', color: '#22C55E', label: 'En lÃ­nea', icon: 'ðŸŸ¢' },
                  { key: 'away', color: '#F59E0B', label: 'Ausente', icon: 'ðŸŒ™' },
                  { key: 'dnd', color: '#EF4444', label: 'No molestar', icon: 'â›”' },
                  { key: 'invisible', color: '#555', label: 'Invisible', icon: 'ðŸ‘»' },
                ].map(opt => (
                  <button key={opt.key} onClick={() => changeStatus(opt.key)} style={{ width: '100%', display: 'flex', alignItems: 'center', gap: 8, padding: '10px 14px', border: 'none', borderBottom: '1px solid rgba(255,255,255,0.05)', background: myStatus === opt.key ? 'rgba(255,255,255,0.06)' : 'transparent', cursor: 'pointer' }}>
                    ...
                    {myStatus === opt.key && <span style={{ marginLeft: 'auto', fontSize: 10, color: opt.color }}>âœ“</span>}
                  </button>
                ))}
              </div>
            )}
        ...
        <div style={{ margin: '0 18px 12px', background: 'rgba(124,58,237,0.06)', border: '1px solid rgba(124,58,237,0.2)', borderRadius: 14, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>
              {partyState.status === 'pending' ? 'Esperando que acepten la invitaciÃ³nâ€¦' : partyState.status === 'ready' ? 'Â¡Listo! AndÃ¡ a Ranked para buscar partida 2v2' : partyState.status === 'searching' ? 'Buscando rivales 2v2â€¦' : partyState.status}
            </p>
          </div>
      ...
      <div style={{ margin: '0 18px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 18, overflow: 'hidden' }}>
        ...
        <div style={{ display: 'flex', borderBottom: '1px solid rgba(255,255,255,0.06)', background: 'rgba(255,255,255,0.02)' }}>
          ...
          <button onClick={() => { setFriendTab('add'); setFriendSearch(''); }} style={{ flex: 1, padding: '12px 0', background: 'transparent', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, borderBottom: friendTab === 'add' ? '2px solid #22C55E' : '2px solid transparent', transition: 'all 0.15s' }}>
            <span style={{ fontSize: 14 }}>âž•</span>
        ...
        {friendTab === 'list' ? (
          <div>
            <div style={{ padding: '10px 12px', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 10, padding: '8px 12px' }}>
                <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.2)' }}>ðŸ”</span>
                <input value={friendSearch} onChange={e => setFriendSearch(e.target.value)} placeholder="Buscar amigoâ€¦" maxLength={50} style={{ flex: 1, background: 'transparent', border: 'none', color: '#fff', fontSize: 12, outline: 'none' }} />
              </div>
            </div>
            {friends.length === 0 ? (
              <div style={{ padding: '40px 16px', textAlign: 'center' }}>
                <div style={{ width: 56, height: 56, borderRadius: 16, background: 'linear-gradient(135deg,#6366F1,#818CF8)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px', fontSize: 24 }}>ðŸ‘¥</div>
                <p style={{ margin: '0 0 6px', fontSize: 14, fontWeight: 700, color: 'rgba(255,255,255,0.7)' }}>Sin amigos aÃºn</p>
                <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.35)' }}>TocÃ¡ <b style={{ color: '#22C55E' }}>âž• Agregar</b> para buscar jugadores</p>
              </div>
            ) : (
              <div>
                {(() => {
                  ...
                  return (<>
                    {renderGroup('En partida', 'âš”ï¸', '#34D399', filtered.filter(f => f.online === 'in_match'), 'in_match')}
                    {renderGroup('Buscando', 'ðŸ”', '#FBBF24', filtered.filter(f => f.online === 'searching'), 'searching')}
                    {renderGroup('En lÃ­nea', 'ðŸŸ¢', '#22C55E', filtered.filter(f => f.online === 'online'), 'online')}
                    {renderGroup('Ausente', 'ðŸŒ™', '#F59E0B', filtered.filter(f => f.online === 'away'), 'away')}
                    {renderGroup('No molestar', 'â›”', '#EF4444', filtered.filter(f => f.online === 'dnd'), 'dnd')}
                    {renderGroup('Desconectado', 'ðŸ’¤', null, filtered.filter(f => !f.online || f.online === 'offline'), 'offline')}
                  </>);
                })()}
              </div>
            )}
          ...
          <div>
            {friendRequests.length === 0 ? (
              <div style={{ padding: '40px 16px', textAlign: 'center' }}>
                <div style={{ width: 56, height: 56, borderRadius: 16, background: 'linear-gradient(135deg,#FF8C00,#F59E0B)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px', fontSize: 24 }}>ðŸ“©</div>
                <p style={{ margin: '0 0 6px', fontSize: 14, fontWeight: 700, color: 'rgba(255,255,255,0.7)' }}>Sin solicitudes</p>
                <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.35)' }}>Las solicitudes de amistad aparecen acÃ¡</p>
              </div>
            ) : (
              <div>
                {friendRequests.map(rq => (
                  <div key={rq.fromId} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                    ...
                    <button onClick={() => acceptRequest(rq.fromId, rq.fromName)} style={{ padding: '6px 12px', borderRadius: 8, border: '1px solid rgba(52,211,153,0.3)', background: 'rgba(52,211,153,0.15)', color: '#34D399', fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>âœ“</button>
                    <button onClick={() => rejectRequest(rq.fromId)} style={{ padding: '6px 10px', borderRadius: 8, border: '1px solid rgba(239,68,68,0.2)', background: 'rgba(239,68,68,0.08)', color: '#EF4444', fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>âœ•</button>
                  </div>
                ))}
              </div>
            )}
          ...
          <div>
            <div style={{ padding: '12px' }}>
              <div style={{ display: 'flex', gap: 8 }}>
                <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 8, background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(34,197,94,0.25)', borderRadius: 12, padding: '10px 12px' }}>
                  <span style={{ fontSize: 13, color: '#22C55E' }}>ðŸ”</span>
                  <input value={friendSearch} onChange={e => setFriendSearch(e.target.value)} placeholder="Nombre de jugadorâ€¦" maxLength={50} style={{ flex: 1, background: 'transparent', border: 'none', color: '#fff', fontSize: 12, outline: 'none' }} />
                </div>
                {friendSearch.length >= 2 && (
                  <button onClick={() => { setFriendSearch(''); setFriendResults([]); }} style={{ padding: '0 12px', borderRadius: 10, border: '1px solid rgba(255,255,255,0.08)', background: 'rgba(255,255,255,0.04)', color: 'rgba(255,255,255,0.4)', fontSize: 12, cursor: 'pointer', fontWeight: 700 }}>âœ•</button>
                )}
              </div>
            </div>
            {friendSearching ? (
              <div style={{ padding: '20px 16px', textAlign: 'center' }}><p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.3)' }}>Buscandoâ€¦</p></div>
                  ...
                  return (
                    <div key={p.userId} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 14px', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                      ...
                      {alreadyFriend ? (
                        ...
                        <button onClick={() => addFriend(p.userId, p.userName)} disabled={friendAdding === p.userId} style={{ padding: '6px 14px', borderRadius: 8, border: '1px solid rgba(52,211,153,0.3)', background: 'rgba(52,211,153,0.1)', color: '#34D399', fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>{friendAdding === p.userId ? 'â€¦' : 'ðŸ“© Solicitud'}</button>
                      )}
                    </div>
                  );
                })}
              ...
              <div style={{ padding: '24px 16px', textAlign: 'center' }}>
                <p style={{ margin: '0 0 4px', fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>EscribÃ­ un nombre para buscar</p>
                <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.15)' }}>MÃ­nimo 2 caracteres</p>
              </div>
            )}
            ...
            {(() => {
              ...
              return (
                <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)', marginTop: 4 }}>
                  <div style={{ padding: '10px 14px 6px', display: 'flex', alignItems: 'center', gap: 6 }}>
                    <span style={{ fontSize: 12 }}>ðŸ•¹ï¸</span>
                  ...
                  {recentPlayers.map(rp => (
                    <div key={rp.id} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 14px', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                      ...
                      {sentIds.has(rp.id) ? (
                        ...
                        <button onClick={() => addFriend(rp.id, rp.name)} disabled={friendAdding === rp.id} style={{ padding: '6px 14px', borderRadius: 8, border: '1px solid rgba(52,211,153,0.3)', background: 'rgba(52,211,153,0.1)', color: '#34D399', fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>{friendAdding === rp.id ? 'â€¦' : 'ðŸ“© Solicitud'}</button>
                      )}
                    </div>
                  ))}
                </div>
      ...
      {chatOpen && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(4px)', WebkitBackdropFilter: 'blur(4px)', zIndex: 9998, display: 'flex', flexDirection: 'column' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '14px 18px', borderBottom: '1px solid rgba(255,255,255,0.08)', background: '#0D0D15' }}>
            <button onClick={() => setChatOpen(null)} style={{ background: 'none', border: 'none', color: '#FF8C00', fontSize: 18, cursor: 'pointer', padding: 4, flexShrink: 0 }}>â†</button>
          ...
          {partyState && (
            <div style={{ padding: '8px 18px', background: 'rgba(124,58,237,0.08)', borderBottom: '1px solid rgba(124,58,237,0.2)', display: 'flex', alignItems: 'center', gap: 10 }}>
              <span style={{ fontSize: 14 }}>ðŸ‘¥</span>
              <p style={{ margin: 0, flex: 1, fontSize: 12, color: '#A78BFA', fontWeight: 700 }}>Party {partyState.status === 'pending' ? '(esperando respuesta)' : partyState.status === 'ready' ? 'âœ“ Listo' : partyState.status === 'searching' ? 'ðŸ” Buscandoâ€¦' : partyState.status}</p>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '12px 18px', display: 'flex', flexDirection: 'column', gap: 8 }}>
            {chatMessages.length === 0 && (<p style={{ margin: 'auto', fontSize: 13, color: 'rgba(255,255,255,0.2)', textAlign: 'center', padding: '40px 0' }}>No hay mensajes aÃºn. Â¡EscribÃ­ algo!</p>)}
          ...
          <div style={{ display: 'flex', gap: 8, padding: '12px 18px', borderTop: '1px solid rgba(255,255,255,0.08)', background: '#0D0D15' }}>
            <input value={chatInput} onChange={e => setChatInput(e.target.value)} onKeyDown={e => e.key === 'Enter' && sendChatMessage()} placeholder="EscribÃ­ un mensajeâ€¦" maxLength={500} style={{ flex: 1, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.09)', borderRadius: 12, padding: '10px 14px', color: '#fff', fontSize: 14, outline: 'none' }} />
            <button onClick={sendChatMessage} disabled={!chatInput.trim() || chatSending} style={{ background: 'rgba(232,142,0,0.15)', border: '1px solid rgba(232,142,0,0.3)', borderRadius: 12, padding: '0 16px', color: '#FF8C00', fontWeight: 700, cursor: 'pointer', fontSize: 20 }}>â†’</button>
          </div>
        </div>
      )}
      ...
      {/* â•â•â• MODAL PERFIL JUGADOR â•â•â• */}
      {viewProfile && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: '#0B0B12', zIndex: 9999, display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 18px', background: 'rgba(11,11,18,0.95)', backdropFilter: 'blur(20px)', position: 'sticky', top: 0, zIndex: 10, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            {(() => { const fe = friends.find(f => f.userId === viewProfile.userId); if (fe) { const st = fe.online === 'in_match' ? 'En partida' : fe.online === 'searching' ? 'Buscandoâ€¦' : ''; const sc = fe.online === 'in_match' ? '#34D399' : fe.online === 'searching' ? '#FBBF24' : null; if (sc) return <span style={{ fontSize: 10, fontWeight: 700, color: sc }}>â— {st}</span>; } return null; })()}
            {!friends.find(f => f.userId === viewProfile.userId) && viewProfile.userId !== uid && (
              <button onClick={() => addFriend(viewProfile.userId, viewProfile.userName)} disabled={friendAdding === viewProfile.userId} style={{ padding: '7px 14px', borderRadius: 10, border: '1px solid rgba(52,211,153,0.3)', background: 'rgba(52,211,153,0.1)', color: '#34D399', fontWeight: 700, fontSize: 11, cursor: 'pointer' }}>{friendAdding === viewProfile.userId ? 'â€¦' : 'ðŸ“© Agregar'}</button>
            )}
          </div>
          {profileLoading ? (
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.3)' }}>Cargando perfilâ€¦</p>
            </div>
          ) : profileData ? (
            <div style={{ maxWidth: 480, margin: '0 auto', width: '100%' }}>
              ...
              <div style={{ padding: '0 18px 40px' }}>
                  ...
                  return (
                    <>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '22px 0 12px' }}>
                        ...
                        <p style={{ margin: 0, fontSize: 10, fontWeight: 800, color: 'rgba(255,255,255,0.45)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>EstadÃ­sticas</p>
                      </div>
                  ...
                  <div style={{ marginBottom: 6 }}>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', margin: '0 0 12px' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                        ...
                        <p style={{ margin: 0, fontSize: 10, fontWeight: 800, color: 'rgba(255,255,255,0.45)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>ðŸ† Resumen</p>
                      </div>
                      <p style={{ margin: 0, fontSize: 9, color: 'rgba(255,255,255,0.25)', fontWeight: 700 }}>Start.GG Â· {profileStartggStats.totalSets} sets</p>
                    </div>
                      ...
                      <div onClick={() => setShowCharsModalAmigos(false)} style={{ position: 'fixed', inset: 0, zIndex: 9998, background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                        <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 480, maxHeight: '80vh', background: '#111', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '20px 20px 0 0', overflow: 'hidden', display: 'flex', flexDirection: 'column', animation: 'slideUp .25s ease-out' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px 12px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                            ...
                            <button onClick={() => setShowCharsModalAmigos(false)} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.4)', fontSize: 20, cursor: 'pointer', lineHeight: 1 }}>âœ•</button>
                          </div>
                              ...
                              return (
                                <div key={ch.startggCharId} onClick={() => { setShowCharsModalAmigos(false); setCharFromModalAmigos(true); setSelectedCharAmigos(ch.startggCharId); }} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '9px 16px', borderBottom: '1px solid rgba(255,255,255,0.05)', cursor: 'pointer' }}>
                                  ...
                                  <div style={{ flex: 1, minWidth: 0 }}>
                                    ...
                                    <p style={{ margin: '2px 0 0', fontSize: 9, color: cWR >= 50 ? 'rgba(34,197,94,0.6)' : 'rgba(239,68,68,0.6)', fontWeight: 700 }}>{ch.games}g Â· {cWR}% WR</p>
                                  </div>
                                  <span style={{ color: 'rgba(255,255,255,0.2)', fontSize: 14 }}>â€º</span>
                                </div>
                              );
                            })}
                          </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '0 0 12px' }}>
                  <div style={{ height: 14, width: 3, borderRadius: 2, background: 'linear-gradient(180deg,#FF8C00,#E85D00)', flexShrink: 0 }} />
                  <p style={{ margin: 0, fontSize: 10, fontWeight: 800, color: 'rgba(255,255,255,0.45)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>âš”ï¸ Ranked</p>
                </div>
                <div style={{ display: 'flex', gap: 10, marginBottom: 20 }}>
                  {['switch', 'parsec'].map(plat => {
                    const s = profileData.stats?.[plat] || {};
                    const wins = s.wins || 0; const losses = s.losses || 0; const total = wins + losses;
                    const rankName = s.rank || 'PlÃ¡stico I';
                    ...
                    return (
                      <div key={plat} style={{ flex: 1, background: isUnranked ? 'rgba(255,255,255,0.03)' : inPlacement ? 'rgba(255,140,0,0.04)' : `linear-gradient(135deg, ${rankColor}14 0%, transparent 65%)`, border: `1px solid ${isUnranked ? 'rgba(255,255,255,0.07)' : inPlacement ? 'rgba(255,140,0,0.2)' : rankColor + '35'}`, borderRadius: 20, padding: '16px 12px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                        <p style={{ margin: 0, fontSize: 11, fontWeight: 700, color: pColor, textTransform: 'uppercase', letterSpacing: '0.06em' }}>{plat === 'switch' ? 'ðŸŽ® Switch' : 'ðŸ–¥ï¸ Parsec'}</p>
                        ...
                        <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>{wins}W Â· {losses}L</p>
                      </div>
                    );
                  })}
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '0 0 12px' }}>
                  ...
                  <p style={{ margin: 0, fontSize: 10, fontWeight: 800, color: 'rgba(255,255,255,0.45)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>ðŸ‘¥ Ranked 2v2</p>
                </div>
                <div style={{ display: 'flex', gap: 10, marginBottom: 20 }}>
                  {['switch', 'parsec'].map(plat => {
                    ...
                    return (
                      <div key={plat} style={{ flex: 1, background: isUnranked ? 'rgba(255,255,255,0.03)' : inPlacement ? 'rgba(124,58,237,0.04)' : `linear-gradient(135deg, ${rankColor}14 0%, transparent 65%)`, border: `1px solid ${isUnranked ? 'rgba(255,255,255,0.07)' : inPlacement ? 'rgba(124,58,237,0.2)' : rankColor + '35'}`, borderRadius: 20, padding: '16px 12px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
                        <p style={{ margin: 0, fontSize: 11, fontWeight: 700, color: plat === 'switch' ? '#EF4444' : '#8B5CF6', textTransform: 'uppercase', letterSpacing: '0.06em' }}>2V2 {plat === 'switch' ? 'ðŸŽ® Switch' : 'ðŸ–¥ï¸ Parsec'}</p>
                        <div style={{ width: 56, height: 56, borderRadius: '50%', background: (isUnranked || inPlacement) ? 'rgba(255,255,255,0.05)' : `${rankColor}18`, border: `2px solid ${(isUnranked || inPlacement) ? 'rgba(255,255,255,0.1)' : rankColor + '55'}`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28 }}>
                          {(isUnranked || inPlacement) ? <span style={{ color: 'rgba(255,255,255,0.2)', fontWeight: 900, fontSize: 20 }}>?</span> : tierIcon}
                        </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '0 0 12px' }}>
                  <div style={{ height: 14, width: 3, borderRadius: 2, background: 'linear-gradient(180deg,#FF8C00,#E85D00)', flexShrink: 0 }} />
                  <p style={{ margin: 0, fontSize: 10, fontWeight: 800, color: 'rgba(255,255,255,0.45)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>ðŸ“‹ Historial</p>
                </div>
                          ...
                          <div style={{ position: 'relative', display: 'flex', alignItems: 'center', height: '100%' }}>
                            <div style={{ width: 58, flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 1, padding: '8px 4px' }}>
                              {charSrc ? (
                                ...
                                <div style={{ width: 38, height: 38, borderRadius: 8, background: 'rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: is2v2 ? 20 : 18 }}>{is2v2 ? 'ðŸ‘¥' : 'âš”ï¸'}</div>
                              )}
                              {isCasual ? (
                            ...
                            <div style={{ flex: 1, padding: '9px 0', display: 'flex', flexDirection: 'column', justifyContent: 'center', gap: 2, minWidth: 0 }}>
                              ...
                              <p style={{ margin: 0, fontSize: 10, color: 'rgba(255,255,255,0.4)' }}>
                                {platLabel(m.platform)} Â· {timeAgo(m.playedAt)}
                              </p>
                              {!isCasual && !is2v2 && (
                                isMyPlacement ? (
                            ...
                            <div style={{ padding: '9px 10px', flexShrink: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 2 }}>
                              ...
                              {myScore != null && <p style={{ margin: 0, fontSize: 10, fontWeight: 800, color: 'rgba(255,255,255,0.45)' }}>{myScore}â€“{oppScore ?? 0}</p>}
                            </div>
                          </div>
                        </div>
                      );
...
/* --- TAB PERFIL ------------------------------------------------ */
function platLabel(p) { return p === 'switch' ? 'ðŸŽ® Switch' : 'ðŸ–¥ï¸ Parsec'; }
...
function TabPerfil({ user }) {
    ...
    if (uid2) {
      fetch('/api/players/profile?id=' + encodeURIComponent(uid2))
        ...
        .then(p => {
          ...
          // Banner de actualizaciÃ³n de Ã­cono: solo iOS standalone que aÃºn no lo cerrÃ³
  ...
  // Calcular personaje mÃ¡s usado del historial
  const mostUsedChar = (() => {
  ...
  return (
    ...
    <div style={{ paddingBottom: 32 }}>
      {/* â”€â”€ Hero Banner â”€â”€ */}
      <div style={{ position: 'relative', background: '#1a1a1a', overflow: 'hidden', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 10 }}>
        {/* Character picker button â€” top right */}
      ...
      <div style={{ padding: '20px 18px' }}>
        ...
        <div style={{ display: 'flex', gap: 10, marginBottom: 20 }}>
          {[
            ...
            { label: 'W/R', value: (totalW + totalL) > 0 ? Math.round(totalW * 100 / (totalW + totalL)) + '%' : 'â€”', color: '#F59E0B' },
          ].map(st => (
            <div key={st.label} style={{ flex: 1, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 14, padding: '12px 8px', textAlign: 'center' }}>
              <p style={{ margin: 0, fontSize: 18, fontWeight: 900, color: st.color }}>{loading ? 'â€”' : st.value}</p>
              <p style={{ margin: '3px 0 0', fontSize: 9, fontWeight: 700, color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>{st.label}</p>
            </div>
          ))}
        </div>

        {/* â”€â”€ SUMMARY (Start.GG character usage) â”€â”€ */}
        {startggStats && startggStats.charUsage && startggStats.charUsage.length > 0 && (
          <div style={{ marginBottom: 20 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', margin: '0 0 12px' }}>
              ...
              <p style={{ margin: 0, fontSize: 9, color: 'rgba(255,255,255,0.25)', fontWeight: 700 }}>Start.GG Â· {startggStats.totalSets} sets</p>
            </div>
            <div style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: 14, overflow: 'hidden' }}>
            ...
            {showCharsModal && (
              <div onClick={() => setShowCharsModal(false)} style={{ position: 'fixed', inset: 0, zIndex: 9998, background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 480, maxHeight: '80vh', background: '#111', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '20px 20px 0 0', overflow: 'hidden', display: 'flex', flexDirection: 'column', animation: 'slideUp .25s ease-out' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px 12px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                    <p style={{ margin: 0, fontSize: 13, fontWeight: 800, color: '#fff' }}>Todos los personajes</p>
                    <button onClick={() => setShowCharsModal(false)} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.4)', fontSize: 20, cursor: 'pointer', lineHeight: 1 }}>âœ•</button>
                  </div>
                  <div style={{ overflowY: 'auto', WebkitOverflowScrolling: 'touch' }}>
        ...
        <div style={{ display: 'flex', gap: 10, marginBottom: 24 }}>
          {(['switch', 'parsec']).map(plat => {
            ...
            const tierIcon  = rankObj ? (TIER_ICONS[rankObj.tier] || 'ðŸŽ®') : null;
            return (
              <div key={plat} onClick={() => setShowRanks(true)} style={{ flex: 1, background: unranked ? 'rgba(255,255,255,0.04)' : inPlace ? 'rgba(255,140,0,0.04)' : 'linear-gradient(160deg,' + rankColor + '15 0%,transparent 60%)', border: '1px solid ' + (unranked ? 'rgba(255,255,255,0.07)' : inPlace ? 'rgba(255,140,0,0.2)' : rankColor + '30'), borderRadius: 16, padding: '14px 12px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, cursor: 'pointer', transition: 'transform 0.15s', position: 'relative' }}>
                ...
                <p style={{ margin: '6px 0 0', fontSize: 10, color: 'rgba(255,255,255,0.35)' }}>
                  <span style={{ color: '#22C55E', fontWeight: 700 }}>{st?.wins || 0}W</span>{' Â· '}<span style={{ color: '#EF4444', fontWeight: 700 }}>{st?.losses || 0}L</span>
                </p>
              </div>
            );
          })}
                ...
                {profileStartggStats && profileStartggStats.charUsage && profileStartggStats.charUsage.length > 0 && (
                  ...
                  <div style={{ display: 'flex', gap: 10, marginBottom: 20 }}>
                    {['switch', 'parsec'].map(plat => {
                      const s = profileData.stats?.[plat] || {};
                      const wins = s.wins || 0; const losses = s.losses || 0; const total = wins + losses;
                      const rankName = s.rank || 'PlÃ¡stico I'; const rp = s.rankedPoints || 0;
                      const isUnranked = total === 0; const inPlacement = !s?.placementDone && !isUnranked;
                      const rankObj = RANKS.find(r => r.name === rankName) || RANKS[0];
                      const tierIcon = rankObj ? (TIER_ICONS[rankObj.tier] || 'ðŸŽ®') : '?';
                      const rankColor = rankObj?.color || '#9CA3AF';
          ...
          <div onClick={() => setShowRanks(false)} style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)', zIndex: 9999, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
            <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 480, maxHeight: '92vh', display: 'flex', flexDirection: 'column', background: '#12121E', border: '1px solid rgba(255,255,255,0.1)', borderTop: '1px solid rgba(255,255,255,0.12)', borderRadius: '20px 20px 0 0', boxShadow: '0 -8px 40px rgba(0,0,0,0.5)' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px 12px', borderBottom: '1px solid rgba(255,255,255,0.08)', flexShrink: 0 }}>
                ...
                <button onClick={() => setShowRanks(false)} style={{ width: 32, height: 32, borderRadius: 10, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.06)', color: 'rgba(255,255,255,0.55)', fontSize: 15, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>âœ•</button>
              </div>
                ...
                {(() => {
                  ...
                  return (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                      {/* SMASHer â€” fila destacada arriba */}
                      {smasher && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '12px 14px', background: smasher.bg, border: '1px solid ' + smasher.border, borderRadius: 14, marginBottom: 4 }}>
                          ...
                          <div style={{ flex: 1 }}>
                            ...
                            <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.4)', lineHeight: 1.4 }}>El rango mÃ¡s alto. DinÃ¡mico: se requiere estar entre los mejores MMR activos.</p>
                          </div>
                      ...
                      {/* Tiers normales: Diamante â†’ PlÃ¡stico (de mayor a menor) */}
                      {[...tiers].reverse().map(({ name, subs }) => {
                        const icon = TIER_ICONS[name] || 'ðŸŽ®';
                      ...
                      <div style={{ marginTop: 6, padding: '12px 14px', background: 'rgba(255,255,255,0.03)', borderRadius: 12, border: '1px solid rgba(255,255,255,0.06)' }}>
                        <p style={{ margin: '0 0 6px', fontSize: 12, fontWeight: 800, color: 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: '0.06em' }}>Â¿CÃ³mo funciona?</p>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 5 }}>
                          {[
                            ['ðŸŽ¯', 'JugÃ¡ 5 partidas de clasificaciÃ³n para obtener tu rango inicial basado en MMR.'],
                            ['ðŸ“ˆ', 'Cada victoria suma RR (Rank Rating, 0â€“100). Al llegar a 100 ascendÃ©s de subdivisiÃ³n.'],
                            ['âš¡', 'Los upsets (ganar a alguien mÃ¡s fuerte) dan RR bonus. Perder contra mÃ¡s dÃ©biles penaliza mÃ¡s.'],
                            ['ðŸ›¡ï¸', 'Al ascender tenÃ©s 2 partidas de escudo que te protegen del descenso.'],
                            ['ðŸ‘‘', 'SMASHer es dinÃ¡mico: necesitÃ¡s mantenerte entre los mejores MMR de la comunidad activa.'],
                          ].map(([emoji, text]) => (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, margin: '0 0 10px' }}>
          ...
          <p style={{ margin: 0, fontSize: 10, fontWeight: 800, color: 'rgba(255,255,255,0.45)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>ðŸ“‹ Historial de partidas</p>
        </div>
        {/* Filtros */}
        ...
        {loading ? (
          ...
          if (filtered.length === 0) return (
            <div style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 16, padding: '32px 20px', textAlign: 'center' }}>
              <p style={{ fontSize: 28, margin: '0 0 8px' }}>{historyFilter === 'casual' ? 'âš”ï¸' : 'ðŸ†'}</p>
              <p style={{ margin: '0 0 4px', fontWeight: 700, fontSize: 14, color: 'rgba(255,255,255,0.5)' }}>Sin partidas aÃºn</p>
              <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.25)' }}>{historyFilter === 'casual' ? 'JugÃ¡ partidas normales para llenar tu historial' : 'JugÃ¡ partidas ranked para ver tu historial'}</p>
            </div>
          );
          return (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              {filtered.map((m, i) => {
                ...
                const myScore = m.winnerScore != null ? (isWin ? m.winnerScore : (m.loserScore ?? 0)) : null;
                const oppScore = m.winnerScore != null ? (isWin ? (m.loserScore ?? 0) : m.winnerScore) : null;
                // Escenarios Ãºnicos para el fondo
                const games = m.games || [];
                const playedStages = games.map(g => g?.result?.stage).filter(Boolean);
                const uniqueStages = [...new Set(playedStages)];
                return (
    ...
    {showMainPicker && (
      <div onClick={() => { setShowMainPicker(false); setPickerStep('char'); }} style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'rgba(0,0,0,0.75)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
        <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 480, maxHeight: '80vh', background: '#111', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '20px 20px 0 0', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px 12px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              {pickerStep === 'alt' && <button onClick={() => setPickerStep('char')} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.5)', fontSize: 16, cursor: 'pointer', padding: 0, lineHeight: 1 }}>â†</button>}
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              <button onClick={() => { setShowMainPicker(false); setPickerStep('char'); }} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.4)', fontSize: 20, cursor: 'pointer', lineHeight: 1 }}>âœ•</button>
            </div>
          </div>
          {pickerStep === 'char' ? (
...
/* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ NOTIF CARD Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
function NotifCard({ notif, onDismiss, userId, userName, onNavigate }) {
  ...
  const icon = isFriendReq ? 'ðŸ“©' : isPartyInvite ? 'ðŸ‘¥' : isBroadcast ? 'ðŸ†' : 'ðŸŽ®';
...
function TabRankings({ user, setTab }) {
  ...
  return (
    <div style={{ padding: '24px 18px' }}>
      ...
      {(mode === 'ranked' || mode === 'ranked2v2') ? (
        <>
          ...
          {rankLoading ? (
            ...
            <div style={{ background: '#10101A', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 20, padding: '44px 24px', textAlign: 'center' }}>
              <span style={{ fontSize: 44 }}>{mode === 'ranked2v2' ? 'ðŸ‘¥' : 'âš”ï¸'}</span>
              <p style={{ margin: '14px 0 6px', fontWeight: 800, fontSize: 16, color: '#fff' }}>Sin partidas {mode === 'ranked2v2' ? '2v2' : 'ranked'} aÃºn</p>
              <p style={{ margin: 0, fontSize: 13, color: 'rgba(255,255,255,0.35)', lineHeight: 1.5 }}>{mode === 'ranked2v2' ? 'JugÃ¡ partidas 2v2 para aparecer en este ranking' : 'JugÃ¡ partidas en la secciÃ³n Match para aparecer en este ranking'}</p>
            </div>
          ) : (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          ...
          {/* â•â•â• JUGADORES EN LÃNEA â•â•â• */}
                ...
                {onlinePlayers.map(p => (
                  <div key={p.userId} style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#10101A', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 12, padding: '10px 14px' }}>
                    ...
                    <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', padding: '2px 8px', background: 'rgba(255,255,255,0.04)', borderRadius: 8 }}>
                      {p.platform === 'switch' ? 'ðŸŽ® Switch' : 'ðŸ–¥ï¸ Parsec'}
                    </span>
                  </div>
                ))}
              </div>
        ...
        <>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
            <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.3)' }}>{mode === 'ba' ? 'ðŸ“ Buenos Aires' : 'INC'}</p>
        ...
        <>
          ...
          {!charSel ? (
            <>
              {/* BÃºsqueda + grid */}
              <input
                placeholder="ðŸ” Buscar personajeâ€¦"
                value={charSearch}
            ...
            <>
                ...
                {(() => { const c = CHARACTERS.find(x => x.id === charSel); return c ? (
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10, flex: 1 }}>
                    ...
                    <div>
                      ...
                      <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>{charPlat === 'switch' ? 'ðŸŽ® Switch Online' : 'ðŸ–¥ï¸ Parsec'}</p>
                    </div>
                  </div>
                ) : null; })()}
              </div>
              ...
              {charLoading ? (
                ...
                <div style={{ background: '#10101A', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 20, padding: '44px 24px', textAlign: 'center' }}>
                  ...
                  <p style={{ margin: '14px 0 6px', fontWeight: 800, fontSize: 16, color: '#fff' }}>Sin partidas todavÃ­a</p>
                  <p style={{ margin: 0, fontSize: 13, color: 'rgba(255,255,255,0.35)', lineHeight: 1.5 }}>Nadie jugÃ³ ranked con este personaje en esta plataforma aÃºn</p>
                </div>
              ) : (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                  {charBoard.map((p, i) => (
      ...
      {/* â•â•â• MODAL PERFIL JUGADOR (Rankings) â•â•â• */}
      {viewProfile && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: '#0B0B12', zIndex: 9999, display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
          {/* Sticky top bar */}
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 18px', background: 'rgba(11,11,18,0.95)', backdropFilter: 'blur(20px)', position: 'sticky', top: 0, zIndex: 10, borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
              ...
              <div style={{ padding: '0 18px 40px' }}>
                    ...
                    {showCharsModalRank && (
                      <div onClick={() => setShowCharsModalRank(false)} style={{ position: 'fixed', inset: 0, zIndex: 9998, background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(4px)', display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
                        <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 480, maxHeight: '80vh', background: '#111', border: '1px solid rgba(255,255,255,0.12)', borderRadius: '20px 20px 0 0', overflow: 'hidden', display: 'flex', flexDirection: 'column', animation: 'slideUp .25s ease-out' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '10px 16px 12px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                            <p style={{ margin: 0, fontSize: 13, fontWeight: 800, color: '#fff' }}>Todos los personajes</p>
                            <button onClick={() => setShowCharsModalRank(false)} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.4)', fontSize: 20, cursor: 'pointer', lineHeight: 1 }}>âœ•</button>
                          </div>
                          <div style={{ overflowY: 'auto', WebkitOverflowScrolling: 'touch' }}>
                            {profileStartggStats.charUsage.map((ch, i) => {
                              const localId = ch.localCharId;
                ...
                <div style={{ display: 'flex', gap: 10, marginBottom: 20 }}>
                  {['switch', 'parsec'].map(plat => {
                    const s = profileData.stats?.[plat] || {};
                    const wins = s.wins || 0; const losses = s.losses || 0; const total = wins + losses;
                    const rankName = s.rank || 'PlÃ¡stico 1'; const rp = s.rankedPoints || 0;
                    const isUnranked = total === 0; const inPlacement = !s?.placementDone && !isUnranked;
                    const rankObj = RANKS.find(r => r.name === rankName) || RANKS[0];
                    const tierIcon = rankObj ? (TIER_ICONS[rankObj.tier] || 'ðŸŽ®') : '?';
                    const rankColor = rankObj?.color || '#9CA3AF';
            ...
            <div key={t.id || t.slug} style={{ background: '#10101A', border: t._featured ? '1px solid rgba(255,140,0,0.35)' : '1px solid rgba(232,142,0,0.15)', borderRadius: 18, overflow: 'hidden', opacity: _isFinished ? 0.65 : 1 }}>
              ...
              <div style={{ padding: '14px 16px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                  <div style={{ width: 42, height: 42, borderRadius: 13, background: 'linear-gradient(135deg,rgba(232,142,0,0.25),rgba(232,80,0,0.15))', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 20, flexShrink: 0 }}>ðŸ†</div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 3 }}>
                      ...
                      {t._featured && <span style={{ fontSize: 9, fontWeight: 800, padding: '2px 6px', background: 'rgba(255,140,0,0.2)', color: '#FF8C00', borderRadius: 5, flexShrink: 0 }}>ðŸ“Œ DEST.</span>}
                    </div>
                    <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>ðŸ“… {formatStartggDate(t.startAt)}</p>
                  </div>
                </div>
                <div style={{ display: 'flex', gap: 8, marginTop: 10, flexWrap: 'wrap' }}>
                  {(() => {
                    if (_isFinished) return (
                      <span style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.4)', padding: '3px 8px', background: 'rgba(255,255,255,0.04)', borderRadius: 8 }}>âœ”ï¸ Finalizado</span>
                    );
                    if (_isStarted) return (
                      <span style={{ fontSize: 10, fontWeight: 700, color: '#FF8C00', padding: '3px 8px', background: 'rgba(232,142,0,0.12)', border: '1px solid rgba(232,142,0,0.25)', borderRadius: 8 }}>
                        ðŸš€ En curso{t.startAt ? <> Â· <ElapsedTimer startAt={t.startAt} /></> : ''}
                      </span>
                    );
                    if (t.registrationOpen) return (
                      <span style={{ fontSize: 10, fontWeight: 700, color: '#34D399', padding: '3px 8px', background: 'rgba(52,211,153,0.1)', border: '1px solid rgba(52,211,153,0.2)', borderRadius: 8 }}>âœ… Inscripciones abiertas</span>
                    );
                    return null;
                  })()}
                  <span style={{ fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.4)', padding: '3px 8px', background: 'rgba(255,255,255,0.04)', borderRadius: 8 }}>ðŸ‘¥ {t.attendees} inscriptos</span>
                </div>
                {(t.events || []).map(e => {
                  ...
                  return (
                    <div key={e.id} style={{ marginTop: 12, background: 'rgba(255,255,255,0.03)', borderRadius: 12, padding: '10px 12px' }}>
                      ...
                      <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                        <a href={eventUrl} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', fontSize: 12, fontWeight: 700, color: '#fff', padding: '6px 14px', background: 'rgba(255,255,255,0.08)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 10 }}>Ver evento â†’</a>
                        {checked && enrolled ? (
                          <span style={{ fontSize: 12, fontWeight: 700, color: '#818CF8', padding: '6px 14px', background: 'rgba(99,102,241,0.12)', border: '1px solid rgba(99,102,241,0.25)', borderRadius: 10 }}>ðŸŽŸï¸ Inscrito</span>
                        ) : !_isStarted && !_isFinished && t.registrationOpen ? (
                          <a href={registerUrl} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', fontSize: 12, fontWeight: 700, color: '#fff', padding: '6px 14px', background: 'linear-gradient(135deg,#E88E00,#E85000)', borderRadius: 10 }}>ðŸ“ Inscribirse</a>
                        ) : null}
                      </div>
                    </div>
                  );
...
/* Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ TIP CARD Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ */
          ...
          <div style={{ marginTop: 8, display: 'flex', gap: 6, flexWrap: 'wrap' }}>
            ...
            {(editNewMedia || tip.mediaData) && !editRemoveMedia && (
              <button onClick={() => { setEditRemoveMedia(true); setEditNewMedia(null); }}
                style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 10, padding: '7px 10px', color: '#EF4444', fontSize: 11, cursor: 'pointer' }}>Ã¢Å“â€¢ Quitar media</button>
            )}
          </div>
...
function TabTips() {
    ...
    return (
      <div style={{ padding: '24px 18px' }}>
        ...
        <button onClick={() => { setShowForm(v => !v); setSubmitResult(null); }} style={{
          ...
          {showForm ? 'Ã¢Å“â€¢ Cancelar' : '+ Subir tip'}
        </button>
        ...
        {showForm && (
          <div style={{ background: '#10101A', border: '1px solid rgba(232,142,0,0.2)', borderRadius: 20, padding: 16, marginBottom: 14 }}>
            ...
            <div style={{ marginTop: 10, display: 'flex', gap: 8, flexWrap: 'wrap' }}>
              ...
              {tipMediaData && (
                <button onClick={() => { setTipMediaData(null); setTipMediaName(''); }} style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 10, padding: '8px 10px', color: '#EF4444', fontSize: 11, cursor: 'pointer' }}>Ã¢Å“â€¢ Quitar</button>
              )}
            </div>
        ...
        {submitResult?.ok && (
          <div style={{ background: 'rgba(52,211,153,0.1)', border: '1px solid rgba(52,211,153,0.2)', borderRadius: 14, padding: '10px 14px', marginBottom: 14, textAlign: 'center' }}>
            <span style={{ fontSize: 13, fontWeight: 700, color: '#34D399' }}>Ã¢Å“â€¦ Tip publicado</span>
          </div>
        )}
  ...
  return (
    <div style={{ padding: '0 18px 24px' }}>
      {/* Sticky header: tÃ­tulo + buscador */}
      <div style={{ position: 'sticky', top: 0, zIndex: 10, background: '#0B0B12', padding: '24px 0 12px' }}>
        ...
        <p style={{ margin: '0 0 12px', fontSize: 13, color: 'rgba(255,255,255,0.3)' }}>ElegÃ­ un personaje Â· {CHARS.length} disponibles</p>
        ...
        <div onClick={() => setShowSuggestions(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.75)', zIndex: 9999, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
          <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 480, background: '#0F0F1A', borderRadius: '24px 24px 0 0', padding: '0 0 32px' }}>
            <div style={{ padding: '16px 20px 12px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <p style={{ margin: 0, fontSize: 17, fontWeight: 900, color: '#fff' }}>ðŸ’¬ Sugerencias</p>
              <button onClick={() => setShowSuggestions(false)} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.4)', fontSize: 22, cursor: 'pointer', lineHeight: 1 }}>âœ•</button>
            </div>
            <div style={{ padding: '20px 20px 0' }}>
              ...
              <p style={{ margin: '0 0 4px', fontSize: 11, fontWeight: 700, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: 1 }}>CategorÃ­a</p>
              <div style={{ display: 'flex', gap: 6, marginBottom: 14, flexWrap: 'wrap' }}>
                {['Bug', 'Mejora', 'Nueva funciÃ³n', 'Otro'].map(cat => (
              ...
              {sugResult?.ok && <p style={{ margin: '6px 0 0', fontSize: 12, color: '#34D399' }}>Â¡Gracias por tu sugerencia! âœ“</p>}
              <button
                onClick={async () => {
                  if (!sugMessage.trim()) { setSugResult({ error: 'EscribÃ­ algo antes de enviar' }); return; }
                  ...
                  } catch { setSugResult({ error: 'Error de conexiÃ³n' }); }
              ...
              >
                {sugSending ? 'â³ Enviandoâ€¦' : 'ðŸ“¨ Enviar sugerencia'}
              </button>
            </div>
          </div>
        </div>
...
/* â”€â”€â”€ CharPicker â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function CharPicker({ selected, onSelect, platform, userId }) {
  // â”€ Estado persistido: personajes usados recientemente â”€
    ...
    fetch(`/api/matchmaking/recent-chars?userId=${encodeURIComponent(userId)}`)
      ...
      .then(ids => {
        if (ids && ids.length) {
          ...
          // Redis vacÃ­o â†’ migrar localStorage a Redis
          try {
  ...
  // â”€â”€ Vista colapsada (personaje ya elegido) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  if (char && !expanded) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 12px', background: 'rgba(255,140,0,0.08)', border: '1px solid rgba(255,140,0,0.28)', borderRadius: 14 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {loadingStats && <p style={{ margin: '2px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.3)' }}>Cargando statsâ€¦</p>}
          {!loadingStats && stats?.myStats && (
            <p style={{ margin: '2px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.45)' }}>
              {stats.myStats.wins}V Â· {stats.myStats.losses}D Â· #{stats.myRank ?? 'â€”'} ranking
            </p>
          )}
          {!loadingStats && !stats?.myStats && platform && (
            <p style={{ margin: '2px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.25)' }}>Sin partidas aÃºn con este personaje</p>
          )}
        </div>
        <button
  ...
  // â”€â”€ Vista expandida (picker) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <div>
      ...
      {recents.length > 0 && !search && (
        <div style={{ marginBottom: 10 }}>
          <p style={{ margin: '0 0 6px', fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Ãšltimos jugados</p>
      ...
      {/* BotÃ³n cancelar cambio (si ya hay uno seleccionado) */}
      {char && (
        <button
...
function TabMatch({ bgMM, setBgMM, userId, userName }) {
  ...
  // â”€â”€ Timer de ban/pick (cuenta regresiva 25s) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
  ...
  // â”€â”€ Auto-ban/pick cuando el timer llega a 0 (lado cliente) â”€
  useEffect(() => {
  ...
  // â”€â”€ Timer de confirmaciÃ³n de resultado (1 min) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
  ...
  // â”€â”€ Auto-confirmar cuando el servidor lo seÃ±ala â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
  ...
  // â”€â”€ Timer AFK de chat (15 min) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
  ...
  // â”€â”€ Reclamar victoria AFK cuando el servidor lo autoriza â”€
  useEffect(() => {
  ...
  // â”€â”€ Reset refs cuando cambia el match â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  useEffect(() => {
  ...
  const [parsecRole, setParsecRole]   = useState(() => {
    ...
    return null;
  }); // 'host' | 'nohost' | null â€” modo de conexiÃ³n para matchmaking Parsec
  ...
  // Timer de bÃºsqueda (basado en searchStartedAt para sobrevivir F5)
  useEffect(() => {
  ...
  const startSearch = async (platform) => {
    if (!searchChar) { setFormError('ElegÃ­ tu personaje primero'); return; }
    ...
    } catch { setFormError('Error de conexiÃ³n'); }
  ...
  const startSearch2v2 = async (platform) => {
    if (!rankedParty || rankedParty.status !== 'ready') {
      setFormError('El equipo no estÃ¡ completo todavÃ­a');
      return;
    }
    setLoading(true); setFormError(null);
    try {
  ...
  const joinRankedParty = async (code) => {
    if (!code || code.length < 4) { setFormError('IngresÃ¡ el cÃ³digo de sala (4 caracteres)'); return; }
    setLoading(true); setFormError(null);
    try {
      const r = await fetch('/api/matchmaking/ranked-party', {
        method: 'POST', headers: { 'Content-Type': 'application/json' },
  ...
  // â•â•â• RENDER: RESULTADO FINAL â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    ...
    return (
      <div style={{ padding: '24px 18px' }}>
        ...
        <div style={{ textAlign: 'center', padding: '32px 16px', background: iWon ? 'linear-gradient(135deg,rgba(52,211,153,0.12),rgba(16,185,129,0.06))' : 'linear-gradient(135deg,rgba(239,68,68,0.12),rgba(220,38,38,0.06))', border: '1px solid ' + (iWon ? 'rgba(52,211,153,0.3)' : 'rgba(239,68,68,0.3)'), borderRadius: 24, marginBottom: 16 }}>
          ...
          {isCasualFinished && <p style={{ margin: '0 0 6px', fontSize: 12, fontWeight: 700, color: '#A78BFA', letterSpacing: '0.08em', textTransform: 'uppercase' }}>âš”ï¸ Partida Normal</p>}
          <p style={{ margin: '0 0 6px', fontSize: 28, fontWeight: 900, color: iWon ? '#34D399' : '#EF4444' }}>{iWon ? (is2v2Finished ? 'Â¡Ganaron!' : 'Â¡Ganaste!') : (is2v2Finished ? 'Perdieron' : 'Perdiste')}</p>
          <p style={{ margin: '0 0 12px', fontSize: 13, color: 'rgba(255,255,255,0.45)' }}>{iWon ? 'Bien jugado ðŸ’ª' : 'La prÃ³xima serÃ¡'}</p>
          {stocks && (
            <div style={{ margin: '0 0 10px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 4 }}>
              {Array.from({ length: stocks }, (_, i) => winnerCharData ? <img key={i} src={charImgPath(winnerCharData.img)} alt="" style={{ width: 20, height: 20, objectFit: 'contain' }} /> : <span key={i}>â¤ï¸</span>)}
          ...
          {matchData.format === 'bo3' && matchData.result?.games?.length > 0 && (
            <div style={{ marginTop: 16, textAlign: 'left', background: 'rgba(255,255,255,0.04)', borderRadius: 12, padding: '10px 14px' }}>
              <p style={{ margin: '0 0 6px', fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.3)', textTransform: 'uppercase', letterSpacing: 1 }}>
                Score: {matchData.result.score?.[uid] || 0} â€” {matchData.result.score?.[Object.keys(matchData.result.score || {}).find(k => k !== uid)] || 0}
              </p>
              {matchData.result.games.map(g => {
                ...
                return (
                  <div key={g.gameNum} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '3px 0' }}>
                    <span style={{ fontSize: 12 }}>{gWon ? 'ðŸ†' : 'ðŸ’€'}</span>
  ...
  // â•â•â• RENDER: MATCH ACTIVO (active / pending_confirm / disputed) â•â•â•â•â•â•â•â•â•â•
  if (matchData && ['active','pending_confirm','disputed'].includes(matchStatus)) {
    ...
    const stage    = matchData.stage || 'â€”';
    const STAGE_EMOJI = { 'Battlefield': 'âš”ï¸', 'Final Destination': 'ðŸŒŒ', 'Small Battlefield': 'âš”ï¸', 'PokÃ©mon Stadium 2': 'âš¡', 'Town and City': 'ðŸ™ï¸', 'Smashville': 'ðŸ˜ï¸', 'Hollow Bastion': 'ðŸ¯', 'Kalos': 'â„ï¸' };
    ...
    return (
      <div style={{ padding: '24px 18px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ width: 44, height: 44, borderRadius: 14, background: p ? 'linear-gradient(135deg,' + p.from + ',' + p.to + ')' : '#222', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>{p?.icon || 'ðŸŽ®'}</div>
          <div style={{ flex: 1 }}>
            <p style={{ margin: '0 0 2px', fontWeight: 900, fontSize: 17, color: '#fff' }}>{is2v2 ? 'Â¡Rivales encontrados!' : 'Â¡Rival encontrado!'}</p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#10101A', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 18, padding: '12px 16px' }}>
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: 14, fontWeight: 900, color: '#34D399' }}>{myChar?.name || myData?.charId || 'â€”'}</p>
              </div>
            </div>
            ...
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 10, justifyContent: 'flex-end', textAlign: 'right' }}>
              <div>
                ...
                <p style={{ margin: 0, fontSize: 14, fontWeight: 900, color: '#EF4444' }}>{oppChar?.name || opponent?.charId || 'â€”'}</p>
              </div>
        ...
        <div style={{ position: 'relative', borderRadius: 18, overflow: 'hidden', border: '1px solid rgba(232,142,0,0.2)', height: 88 }}>
          ...
          <div style={{ position: 'relative', background: STAGE_IMG[stage] ? 'linear-gradient(to right, rgba(0,0,0,0.82) 0%, rgba(0,0,0,0.45) 65%, transparent 100%)' : 'linear-gradient(135deg,rgba(232,142,0,0.1),rgba(232,142,0,0.04))', padding: '14px 16px', height: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <p style={{ margin: '2px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.5)' }}>Stock 3 Â· 7 min Â· Sin objetos</p>
          </div>
        </div>
        ...
        <div style={{ background: 'rgba(232,142,0,0.05)', border: '1px solid rgba(232,142,0,0.12)', borderRadius: 14, padding: '10px 14px' }}>
          <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.4)', lineHeight: 1.5 }}>
            {bgMM?.plat === 'switch' ? 'ðŸŽ® CoordinÃ¡ con tu rival quiÃ©n crea la Arena en Nintendo Switch Online.' : 'ðŸ–¥ï¸ CoordinÃ¡ con tu rival quiÃ©n hostea la sesiÃ³n en Parsec.'}
          </p>
        </div>

        {/* Scroll hint */}
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
          <span style={{ fontSize: 18, color: 'rgba(255,255,255,0.15)', animation: 'bounce 1.4s ease-in-out infinite' }}>â†“</span>
            ...
            <div style={{ background: chatAfkTimeLeft <= 60 ? 'rgba(239,68,68,0.08)' : 'rgba(251,191,36,0.07)', border: `1px solid ${chatAfkTimeLeft <= 60 ? 'rgba(239,68,68,0.25)' : 'rgba(251,191,36,0.22)'}`, borderRadius: 14, padding: '10px 14px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
                ...
                <p style={{ margin: 0, fontSize: 12, fontWeight: 800, color: chatAfkTimeLeft <= 60 ? '#EF4444' : '#FBBF24' }}>
                  {chatAfkTimeLeft > 0 ? `${timeStr} para confirmar presencia` : 'Â¡Tiempo agotado!'}
                </p>
              </div>
              {!myPresent && <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.45)' }}>ðŸ‘‡ EnviÃ¡ un mensaje para avisar que estÃ¡s aquÃ­</p>}
              {myPresent && !oppPresent && <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.45)' }}>Tu rival aÃºn no dio seÃ±ales de estar conectado</p>}
              {myPresent && oppPresent && <p style={{ margin: 0, fontSize: 11, color: '#22C55E' }}>âœ… Ambos confirmaron presencia</p>}
            </div>
          );
        })()}
        ...
        <div style={{ background: '#10101A', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 18, overflow: 'hidden' }}>
          <div style={{ padding: '10px 14px 6px', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            {chatAfkTimeLeft !== null && !matchData?.chatPresence?.[uid] && (
              <span style={{ marginLeft: 'auto', fontSize: 10, color: '#FBBF24', fontWeight: 700, background: 'rgba(251,191,36,0.1)', padding: '2px 7px', borderRadius: 6 }}>EnviÃ¡ un mensaje â†“</span>
            )}
          </div>
          <div style={{ height: 130, overflowY: 'auto', padding: '8px 12px', display: 'flex', flexDirection: 'column', gap: 6 }}>
            {chatMessages.length === 0 && (
              <p style={{ margin: 'auto', fontSize: 12, color: 'rgba(255,255,255,0.2)', textAlign: 'center' }}>Sin mensajes aÃºnâ€¦</p>
            )}
            {chatMessages.map(m => {
          ...
          <div style={{ display: 'flex', gap: 8, padding: '8px 10px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
            ...
            />
            <button onClick={sendChat} disabled={!chatInput.trim() || chatSending} style={{ background: 'rgba(232,142,0,0.15)', border: '1px solid rgba(232,142,0,0.3)', borderRadius: 10, padding: '0 14px', color: '#FF8C00', fontWeight: 700, cursor: 'pointer', fontSize: 18 }}>â†’</button>
          </div>
        </div>
        ...
        {matchStatus === 'disputed' ? (
          <div style={{ background: 'rgba(251,191,36,0.08)', border: '1px solid rgba(251,191,36,0.25)', borderRadius: 16, padding: '14px 16px', textAlign: 'center' }}>
            ...
            <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.4)' }}>Reportaron resultados distintos. ContactÃ¡ a un admin.</p>
          </div>
          ...
          matchData.pendingResult.reporterId === uid ? (
            <div style={{ background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.2)', borderRadius: 16, padding: '16px', textAlign: 'center' }}>
              <p style={{ margin: '0 0 6px', fontSize: 20 }}>â³</p>
              <p style={{ margin: 0, fontSize: 13, fontWeight: 700, color: '#818CF8' }}>Esperando que tu rival confirme el resultadoâ€¦</p>
              {confirmTimeLeft !== null && (
                <p style={{ margin: '8px 0 0', fontSize: 11, color: confirmTimeLeft <= 10 ? '#22C55E' : 'rgba(255,255,255,0.3)' }}>
                  {confirmTimeLeft > 0 ? `Se acepta automÃ¡ticamente en ${confirmTimeLeft}s` : 'âœ… Auto-confirmandoâ€¦'}
                </p>
              )}
            </div>
          ) : (
            <div style={{ background: '#10101A', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 18, padding: '14px 16px', textAlign: 'center' }}>
              <p style={{ margin: '0 0 8px', fontSize: 14, fontWeight: 800, color: '#fff' }}>
                Tu rival dice que {matchData.pendingResult.winnerId === uid ? 'vos ganaste' : 'Ã©l ganÃ³'}
              </p>
              {confirmTimeLeft !== null && confirmTimeLeft <= 30 && (
                <p style={{ margin: '-4px 0 8px', fontSize: 11, color: '#EF4444', fontWeight: 700 }}>
                  âš ï¸ Si no respondÃ©s en {confirmTimeLeft}s, se confirma automÃ¡ticamente
                </p>
              )}
              {matchData.pendingResult.winnerId === uid && (
                <div style={{ marginBottom: 12 }}>
                  <p style={{ margin: '0 0 6px', fontSize: 11, fontWeight: 700, color: 'rgba(255,255,255,0.35)', textTransform: 'uppercase', letterSpacing: 0.5 }}>Â¿Con cuÃ¡ntos stocks quedaste?</p>
                  <div style={{ display: 'flex', gap: 6, justifyContent: 'center' }}>
                    {[1,2,3].map(n => (
                      <button key={n} onClick={() => setReportStocks(n)} style={{ flex: 1, maxWidth: 100, padding: '8px 4px', borderRadius: 10, border: '1px solid ' + (reportStocks === n ? 'rgba(255,140,0,0.6)' : 'rgba(255,255,255,0.1)'), background: reportStocks === n ? 'rgba(255,140,0,0.15)' : 'rgba(255,255,255,0.04)', cursor: 'pointer', transition: 'all 0.15s', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 2 }}>
                        {Array.from({ length: n }, (_, i) => myChar ? <img key={i} src={charImgPath(myChar.img)} alt="" style={{ width: 22, height: 22, objectFit: 'contain' }} /> : <span key={i}>â¤ï¸</span>)}
                      </button>
                    ))}
                  </div>
                </div>
          ...
          <div style={{ background: '#10101A', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 18, padding: '14px 16px' }}>
            ...
            {reportError && <p style={{ margin: '0 0 8px', fontSize: 12, color: '#EF4444' }}>{reportError}</p>}
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <button onClick={() => reportResult(is2v2 ? myTeam : uid, reportStocks)} disabled={reportLoading} style={{ padding: '13px', borderRadius: 13, border: '1px solid rgba(52,211,153,0.3)', background: 'rgba(52,211,153,0.08)', color: '#34D399', fontWeight: 800, fontSize: 14, cursor: reportLoading ? 'not-allowed' : 'pointer' }}>ðŸ† {is2v2 ? 'Ganamos' : 'Yo ganÃ©'}</button>
              <button onClick={() => reportResult(is2v2 ? (myTeam === 'team1' ? 'team2' : 'team1') : (uid === matchData.host?.userId ? matchData.guest?.userId : matchData.host?.userId), 1)} disabled={reportLoading} style={{ padding: '13px', borderRadius: 13, border: '1px solid rgba(239,68,68,0.25)', background: 'rgba(239,68,68,0.07)', color: '#EF4444', fontWeight: 800, fontSize: 14, cursor: reportLoading ? 'not-allowed' : 'pointer' }}>ðŸ’€ {is2v2 ? 'Perdimos' : 'PerdÃ­'}</button>
            </div>
          </div>
        ) : null}
        ...
        {!is2v2 && matchStatus !== 'disputed' && (
          showForfeitConfirm ? (
            <div style={{ background: 'rgba(239,68,68,0.06)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 16, padding: '14px 16px', textAlign: 'center' }}>
              <p style={{ margin: '0 0 4px', fontSize: 14, fontWeight: 800, color: '#EF4444' }}>ðŸ³ï¸ Â¿ConfirmÃ¡s que querÃ©s rendirte?</p>
              <p style={{ margin: '0 0 14px', fontSize: 12, color: 'rgba(255,255,255,0.35)' }}>Tu rival ganarÃ¡ automÃ¡ticamente y perderÃ¡s puntos.</p>
              <div style={{ display: 'flex', gap: 10 }}>
                ...
                <button onClick={forfeit} disabled={forfeitLoading} style={{ flex: 1, padding: '10px', borderRadius: 12, border: '1px solid rgba(239,68,68,0.4)', background: 'rgba(239,68,68,0.12)', color: '#EF4444', fontWeight: 800, fontSize: 13, cursor: forfeitLoading ? 'not-allowed' : 'pointer' }}>{forfeitLoading ? 'â³ Procesandoâ€¦' : 'ðŸ³ï¸ SÃ­, rendirme'}</button>
              </div>
            </div>
          ) : (
            <button onClick={() => setShowForfeitConfirm(true)} style={{ width: '100%', padding: '10px', borderRadius: 12, border: '1px solid rgba(255,255,255,0.07)', background: 'transparent', color: 'rgba(255,255,255,0.2)', fontWeight: 600, fontSize: 12, cursor: 'pointer' }}>ðŸ³ï¸ Rendirse</button>
          )
        )}
      </div>
    );
  ...
  // â•â•â• RENDER: BANNING (Bo3 stage bans) â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  if (matchStatus === 'banning' && matchData) {
    ...
    if (banPhase === 'j1_ban') {
      if (iAmJ1) {
        subtitle = 'BaneÃ¡ 1 escenario';
        showStages = true; canSelect = true; maxSelect = 1;
      } else {
        subtitle = is2v2 && !isCapitan ? 'Tu capitÃ¡n estÃ¡ baneandoâ€¦' : 'Tu rival estÃ¡ baneandoâ€¦';
      }
    } else if (banPhase === 'j2_ban') {
      if (iAmJ2) {
        subtitle = 'BaneÃ¡ 2 escenarios';
      ...
      if (iAmJ1) {
        subtitle = 'ElegÃ­ un escenario';
        showStages = true; canSelect = true; maxSelect = 1; isPickMode = true;
      } else {
        subtitle = 'Tu rival estÃ¡ eligiendo escenarioâ€¦';
      }
    } else if (banPhase === 'winner_ban') {
      if (iAmPrevWinner) {
        subtitle = 'BaneÃ¡ 3 escenarios';
      ...
      if (!iAmPrevWinner) {
        ...
        subtitle = is2v2 && !isCapitan ? 'Tu capitÃ¡n estÃ¡ eligiendo escenarioâ€¦' : 'Tu rival estÃ¡ eligiendo escenarioâ€¦';
      }
    }
    ...
    return (
      <div style={{ padding: '24px 18px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ width: 44, height: 44, borderRadius: 14, background: p ? 'linear-gradient(135deg,' + p.from + ',' + p.to + ')' : '#222', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>{p?.icon || 'ðŸŽ®'}</div>
          <div style={{ flex: 1 }}>
            <p style={{ margin: '0 0 2px', fontWeight: 900, fontSize: 17, color: '#fff' }}>âš”ï¸ Game {gameNum} de 3</p>
        ...
        {(myChar || oppChar) && (
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, background: '#10101A', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 14, padding: '10px 14px' }}>
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <p style={{ margin: 0, fontSize: 12, fontWeight: 800, color: '#34D399' }}>{myChar?.name || 'â€”'}</p>
            </div>
            <span style={{ fontSize: 13, fontWeight: 900, color: 'rgba(255,255,255,0.15)' }}>VS</span>
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 8, justifyContent: 'flex-end' }}>
              <p style={{ margin: 0, fontSize: 12, fontWeight: 800, color: '#EF4444' }}>{oppChar?.name || opponent?.charId || 'â€”'}</p>
        ...
        <div style={{ textAlign: 'center', padding: '10px 16px', background: 'rgba(232,142,0,0.08)', border: '1px solid rgba(232,142,0,0.2)', borderRadius: 14 }}>
          ...
          {showStages && !isPickMode && <p style={{ margin: '4px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>SeleccionÃ¡ {maxSelect} escenarios para banear</p>}
          {showStages && isPickMode && <p style={{ margin: '4px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>ElegÃ­ en quÃ© escenario jugar</p>}
          ...
          {banTimeLeft !== null && (
            <div style={{ marginTop: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
              ...
              <span style={{ fontSize: 11, color: banTimeLeft <= 5 ? '#EF4444' : 'rgba(255,255,255,0.35)', fontWeight: canSelect ? 700 : 400 }}>
                {canSelect ? (banTimeLeft <= 5 ? 'Â¡Auto-ban en instantes!' : `${banTimeLeft}s para ${isPickMode ? 'elegir' : 'banear'}`) : `Rival tiene ${banTimeLeft}s`}
              </span>
            </div>
          )}
        </div>
          ...
          <>
            ...
            {isPickMode ? (
              <button onClick={() => selectedBans.length === 1 && pickStage(selectedBans[0])} disabled={selectedBans.length !== 1 || banLoading} style={{ width: '100%', padding: '14px', borderRadius: 16, border: 'none', background: selectedBans.length === 1 ? 'linear-gradient(135deg,#22C55E,#16A34A)' : 'rgba(255,255,255,0.08)', color: selectedBans.length === 1 ? '#fff' : 'rgba(255,255,255,0.3)', fontWeight: 800, fontSize: 15, cursor: selectedBans.length === 1 ? 'pointer' : 'not-allowed', transition: 'all 0.2s' }}>
                {banLoading ? 'â³ Confirmandoâ€¦' : `âš”ï¸ Jugar en ${selectedBans[0] || '...'}`}
              </button>
            ) : (
              <button onClick={submitBans} disabled={selectedBans.length !== maxSelect || banLoading} style={{ width: '100%', padding: '14px', borderRadius: 16, border: 'none', background: selectedBans.length === maxSelect ? 'linear-gradient(135deg,#EF4444,#DC2626)' : 'rgba(255,255,255,0.08)', color: selectedBans.length === maxSelect ? '#fff' : 'rgba(255,255,255,0.3)', fontWeight: 800, fontSize: 15, cursor: selectedBans.length === maxSelect ? 'pointer' : 'not-allowed', transition: 'all 0.2s' }}>
                {banLoading ? 'â³ Enviandoâ€¦' : `ðŸš« Confirmar baneos (${selectedBans.length}/${maxSelect})`}
              </button>
            )}
          </>
        ) : (
        ...
        {!is2v2 && (
          showForfeitConfirm ? (
            <div style={{ background: 'rgba(239,68,68,0.06)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 16, padding: '14px 16px', textAlign: 'center' }}>
              <p style={{ margin: '0 0 4px', fontSize: 14, fontWeight: 800, color: '#EF4444' }}>ðŸ³ï¸ Â¿ConfirmÃ¡s que querÃ©s rendirte?</p>
              <p style={{ margin: '0 0 14px', fontSize: 12, color: 'rgba(255,255,255,0.35)' }}>Tu rival ganarÃ¡ el set y perderÃ¡s puntos.</p>
              <div style={{ display: 'flex', gap: 10 }}>
                <button onClick={() => setShowForfeitConfirm(false)} disabled={forfeitLoading} style={{ flex: 1, padding: '10px', borderRadius: 12, border: '1px solid rgba(255,255,255,0.1)', background: 'rgba(255,255,255,0.05)', color: 'rgba(255,255,255,0.6)', fontWeight: 700, fontSize: 13, cursor: 'pointer' }}>Cancelar</button>
                <button onClick={forfeit} disabled={forfeitLoading} style={{ flex: 1, padding: '10px', borderRadius: 12, border: '1px solid rgba(239,68,68,0.4)', background: 'rgba(239,68,68,0.12)', color: '#EF4444', fontWeight: 800, fontSize: 13, cursor: forfeitLoading ? 'not-allowed' : 'pointer' }}>{forfeitLoading ? 'â³ Procesandoâ€¦' : 'ðŸ³ï¸ SÃ­, rendirme'}</button>
              </div>
            ...
            {matchData.games.filter(g => g.result).map(g => {
              ...
              return (
                <div key={g.gameNum} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '4px 0' }}>
                  <span style={{ fontSize: 14 }}>{won ? 'ðŸ†' : 'ðŸ’€'}</span>
                  <span style={{ fontSize: 12, fontWeight: 700, color: won ? '#22C55E' : '#EF4444' }}>Game {g.gameNum}</span>
                  <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)' }}>â€” {g.stage}</span>
                </div>
              );
            })}
          </div>
  ...
  // â•â•â• RENDER: BUSCANDO RANKED â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
      ...
      <div style={{ padding: '24px 18px' }}>
        <div style={{ background: sp ? 'linear-gradient(135deg,' + sp.from + '15,' + sp.to + '08)' : 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 24, padding: '32px 24px', textAlign: 'center', marginBottom: 16 }}>
          <div style={{ position: 'relative', width: 72, height: 72, margin: '0 auto 18px' }}>
            ...
            <div style={{ position: 'absolute', inset: '16px', background: sp ? 'linear-gradient(135deg,' + sp.from + ',' + sp.to + ')' : '#333', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>{sp?.icon || 'âš¡'}</div>
          </div>
          <p style={{ margin: '0 0 6px', fontSize: 18, fontWeight: 900, color: '#fff' }}>{bgMM?.mode === '2v2' ? 'Buscando rivales 2v2â€¦' : 'Buscando rivalâ€¦'}</p>
          <p style={{ margin: '0 0 4px', fontSize: 14, fontWeight: 800, color: sp?.from || '#FF8C00' }}>{sp?.label || ''}{bgMM?.gameType === 'casual' ? ' (Normal)' : ''}</p>
          <p style={{ margin: '0 0 16px', fontSize: 13, color: 'rgba(255,255,255,0.4)' }}>PodÃ©s navegar la app sin cancelar</p>
  ...
  // â•â•â• RENDER: SALA WAITING (reconexiÃ³n a sala anterior) â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
      ...
      <div style={{ padding: '24px 18px' }}>
        ...
        <div style={{ background: p ? 'linear-gradient(135deg,' + p.from + '15,' + p.to + '08)' : 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 24, padding: '32px 24px', textAlign: 'center', marginBottom: 16 }}>
          <div style={{ position: 'relative', width: 72, height: 72, margin: '0 auto 18px' }}>
            ...
            <div style={{ position: 'absolute', inset: '16px', background: p ? 'linear-gradient(135deg,' + p.from + ',' + p.to + ')' : '#333', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 22 }}>{p?.icon || 'âš¡'}</div>
          </div>
          <p style={{ margin: '0 0 6px', fontSize: 18, fontWeight: 900, color: '#fff' }}>Esperando rivalâ€¦</p>
          <p style={{ margin: '0 0 20px', fontSize: 13, color: 'rgba(255,255,255,0.4)' }}>PodÃ©s navegar la app sin cancelar</p>
          <p style={{ margin: '0 0 6px', fontSize: 11, fontWeight: 700, color: 'rgba(255,255,255,0.35)', textTransform: 'uppercase', letterSpacing: 1 }}>CÃ³digo de sala</p>
  ...
  // â•â•â• RENDER: PANTALLA PRINCIPAL â€” Buscar Ranked â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  return (
    <div style={{ padding: '24px 18px' }}>
      {/* Modal CÃ³mo jugar */}
      {showHowToPlay && (
        <div onClick={() => setShowHowToPlay(false)} style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.75)', zIndex: 9999, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
          <div onClick={e => e.stopPropagation()} style={{ width: '100%', maxWidth: 480, background: '#0F0F1A', borderRadius: '24px 24px 0 0', padding: '0 0 32px', maxHeight: '88vh', overflowY: 'auto' }}>
            <div style={{ position: 'sticky', top: 0, background: '#0F0F1A', padding: '16px 20px 12px', borderBottom: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <p style={{ margin: 0, fontSize: 17, fontWeight: 900, color: '#fff' }}>ðŸ“– CÃ³mo jugar</p>
              <button onClick={() => setShowHowToPlay(false)} style={{ background: 'none', border: 'none', color: 'rgba(255,255,255,0.4)', fontSize: 22, cursor: 'pointer', lineHeight: 1 }}>âœ•</button>
            </div>
            <div style={{ padding: '20px 20px 0' }}>
              {[
                { icon: 'âš”ï¸', title: 'Formato Bo3', desc: 'Las partidas ranked son al mejor de 3 juegos (Bo3). GanÃ¡s el set cuando ganÃ¡s 2 juegos.' },
                { icon: 'ðŸš«', title: 'Fase de baneo â€” Game 1', desc: 'Se sortea quiÃ©n es J1 y J2.\nâ€¢ J1 banea 1 escenario.\nâ€¢ J2 banea 2 escenarios.\nâ€¢ J1 elige el escenario donde se juega.' },
                { icon: 'ðŸ”„', title: 'Fase de baneo â€” Games 2 y 3', desc: 'El ganador del game anterior banea 3 escenarios. El perdedor elige dÃ³nde jugar el siguiente game.' },
                { icon: 'ðŸ‘¥', title: '2v2 â€” Capitanes', desc: 'En partidas 2v2, el creador de la sala es el capitÃ¡n del equipo. Solo los capitanes pueden banear y elegir escenarios.' },
                { icon: 'ðŸ“Š', title: 'Reportar resultado', desc: 'Al terminar cada game, ambos jugadores reportan quiÃ©n ganÃ³ y con cuÃ¡ntos stocks de ventaja. Si hay discrepancia, se abre una disputa.' },
                { icon: 'â°', title: 'AFK / Tiempo lÃ­mite', desc: 'TenÃ©s 25 segundos por turno en la fase de baneo. Si no actuÃ¡s, el sistema elige automÃ¡ticamente. Si tu rival no aparece al chat en 15 minutos, podÃ©s reclamar victoria.' },
                { icon: 'ðŸ“ˆ', title: 'Ranking y RP', desc: 'Cada victoria suma RP y cada derrota resta 10 RP. Los primeros 5 juegos son de posicionamiento y definen tu rango inicial.' },
                { icon: 'ðŸŽ¯', title: 'Modos', desc: 'â€¢ Ranked: afecta tu rango y RP.\nâ€¢ Normal: partidas casuales sin efecto en el rango.' },
              ].map(({ icon, title, desc }) => (
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
        ...
        <button onClick={() => setShowHowToPlay(true)} style={{ display: 'flex', alignItems: 'center', gap: 5, background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 10, padding: '6px 10px', color: 'rgba(255,255,255,0.55)', fontSize: 12, fontWeight: 700, cursor: 'pointer' }}>â“ CÃ³mo jugar</button>
      </div>
      <p style={{ margin: '0 0 12px', fontSize: 13, color: 'rgba(255,255,255,0.35)' }}>{matchTypeMode === 'casual' ? 'Partidas casuales sin efecto en el rango' : 'ElegÃ­ tu personaje y buscÃ¡ rival'}</p>
      ...
      <div style={{ display: 'flex', gap: 0, marginBottom: 20, background: 'rgba(255,255,255,0.04)', borderRadius: 14, border: '1px solid rgba(255,255,255,0.06)', overflow: 'hidden' }}>
        {[{ id: 'ranked', label: 'âš”ï¸ Ranked', accent: '#FF8C00' }, { id: 'casual', label: 'ðŸŽ® Normal', accent: '#A78BFA' }].map(t => (
      ...
      {matchTypeMode !== 'casual' && (
        <div style={{ display: 'flex', gap: 0, marginBottom: 20, background: 'rgba(255,255,255,0.04)', borderRadius: 14, border: '1px solid rgba(255,255,255,0.06)', overflow: 'hidden' }}>
          {[{ id: '1v1', label: 'âš”ï¸ Solo (1v1)' }, { id: '2v2', label: 'ðŸ‘¥ Dobles (2v2)' }].map(m => (
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, background: 'linear-gradient(135deg,rgba(124,58,237,0.14),rgba(255,140,0,0.08))', border: '1px solid rgba(124,58,237,0.3)', borderRadius: 18, padding: '14px 16px', marginBottom: 20, cursor: 'default' }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ margin: '0 0 2px', fontWeight: 800, fontSize: 14, color: '#fff' }}>
              {bgMM.status === 'waiting'        ? 'Sala activa â€” esperando rival' :
               bgMM.status === 'pending_accept' ? 'Â¡Match encontrado!' :
               bgMM.status === 'active'         ? 'Â¡Partida en juego!' :
               bgMM.status === 'pending_confirm' ? 'ConfirmÃ¡ el resultado' :
                                                   'Resultado en disputa'}
            </p>
          </div>
        </div>
      ...
      {onlineCount && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 16, padding: '8px 14px', background: 'rgba(34,197,94,0.06)', border: '1px solid rgba(34,197,94,0.15)', borderRadius: 12 }}>
          ...
          <span style={{ fontSize: 12, color: 'rgba(255,255,255,0.5)' }}>
            ...
            {onlineCount.switch > 0 ? ` Â· ${onlineCount.switch} Switch` : ''}
            {onlineCount.parsec > 0 ? ` Â· ${onlineCount.parsec} Parsec` : ''}
          </span>
        </div>
      )}
      ...
      {matchTypeMode === 'casual' ? (
        <>
          ...
          {casualMode === '1v1' ? (
            /* Botones de bÃºsqueda casual 1v1 */
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {PLATFORMS.map(px => (
                <button
                  key={px.id}
            ...
            <div>
              {!casualParty ? (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  <p style={{ margin: '0 0 4px', fontSize: 13, color: 'rgba(255,255,255,0.45)', textAlign: 'center' }}>FormÃ¡ un equipo antes de buscar rivales 2v2</p>
                  {PLATFORMS.map(px => (
                    <button key={'cp-' + px.id} onClick={() => createCasualParty(px.id)} disabled={loading}
                      ...
                      <div style={{ flex: 1, textAlign: 'left' }}>
                        ...
                        <p style={{ margin: '2px 0 0', fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>GenerÃ¡s un cÃ³digo para invitar a tu compaÃ±ero</p>
                      </div>
                    </button>
                  ))}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, padding: '8px 0' }}>
                  {casualParty.leader?.userId === uid ? (
                    <>
                      <p style={{ margin: 0, fontSize: 13, color: 'rgba(255,255,255,0.55)', textAlign: 'center' }}>CompartÃ­ este cÃ³digo con tu compaÃ±ero</p>
                      <div style={{ background: 'rgba(167,139,250,0.1)', border: '2px solid rgba(167,139,250,0.4)', borderRadius: 20, padding: '18px 32px', textAlign: 'center' }}>
                        <p style={{ margin: '0 0 6px', fontSize: 11, fontWeight: 700, color: 'rgba(167,139,250,0.7)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>CÃ³digo de sala</p>
                        <p style={{ margin: 0, fontSize: 44, fontWeight: 900, color: '#fff', letterSpacing: 10 }}>{casualParty.code}</p>
                        <button onClick={() => { try { navigator.clipboard.writeText(casualParty.code); } catch {} }} style={{ marginTop: 10, background: 'rgba(167,139,250,0.2)', border: '1px solid rgba(167,139,250,0.3)', borderRadius: 8, color: '#A78BFA', fontWeight: 700, fontSize: 11, padding: '5px 14px', cursor: 'pointer' }}>ðŸ“‹ Copiar cÃ³digo</button>
                      </div>
                      <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.35)', textAlign: 'center' }}>Plataforma: <strong style={{ color: '#fff' }}>{casualParty.platform === 'switch' ? 'ðŸŽ® Switch' : 'ðŸ’» Parsec'}</strong></p>
                    </>
                  ) : (
                    <p style={{ margin: 0, fontSize: 13, color: 'rgba(255,255,255,0.5)', textAlign: 'center' }}>Esperando que el lÃ­der comience la bÃºsqueda...</p>
                  )}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  <div style={{ background: 'rgba(167,139,250,0.06)', border: '1px solid rgba(167,139,250,0.2)', borderRadius: 16, padding: '14px 16px' }}>
                    <p style={{ margin: '0 0 10px', fontSize: 11, fontWeight: 700, color: 'rgba(167,139,250,0.7)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Tu equipo âœ…</p>
                    {[casualParty.leader, casualParty.partner].map((p, i) => {
                      ...
                      return (
                        <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '8px 0', borderTop: i > 0 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}>
                          {cs ? <img src={cs} alt="" style={{ width: 36, height: 36, objectFit: 'contain', flexShrink: 0 }} onError={e => { e.target.style.display='none'; }} /> : <div style={{ width: 36, height: 36, borderRadius: 8, background: 'rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 18, flexShrink: 0 }}>âš”ï¸</div>}
                          <div>
                            <p style={{ margin: 0, fontWeight: 800, fontSize: 14, color: '#fff' }}>{p.userName}</p>
                            <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.4)' }}>{p.userId === uid ? '(vos)' : 'compaÃ±ero'}</p>
                          </div>
                        </div>
                      );
                    })}
        ...
        <>
          {/* Botones de bÃºsqueda por plataforma */}
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {PLATFORMS.map(px => (
              <button
                key={px.id}
          ...
          <div style={{ marginTop: 10, background: 'rgba(139,92,246,0.06)', border: '1px solid rgba(139,92,246,0.15)', borderRadius: 14, padding: '10px 14px' }}>
            ...
            <div style={{ display: 'flex', gap: 8 }}>
              ...
              >{parsecRole === 'host' ? 'âœ“ ' : ''}Host</button>
              <button
                onClick={() => {
              ...
              >{parsecRole === 'nohost' ? 'âœ“ ' : ''}No Host</button>
            </div>
            <p style={{ margin: '6px 0 0', fontSize: 10, color: 'rgba(255,255,255,0.25)', lineHeight: 1.4 }}>IndicÃ¡ si podÃ©s hostear Parsec. Evita que te emparejen con otro No Host.</p>
          </div>
        </>
      ) : (
        <>
          ...
          {!rankedParty ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              <p style={{ margin: '0 0 4px', fontSize: 13, color: 'rgba(255,255,255,0.45)', textAlign: 'center' }}>FormÃ¡ un equipo antes de buscar rivales Ranked 2v2</p>
              {PLATFORMS.map(px => (
              ...
              {rankedParty.leader?.userId === uid ? (
                <>
                  ...
                  <div style={{ background: 'rgba(255,140,0,0.08)', border: '2px solid rgba(255,140,0,0.4)', borderRadius: 20, padding: '18px 32px', textAlign: 'center' }}>
                    <p style={{ margin: '0 0 6px', fontSize: 11, fontWeight: 700, color: 'rgba(255,140,0,0.7)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>CÃ³digo de sala</p>
                    <p style={{ margin: 0, fontSize: 44, fontWeight: 900, color: '#fff', letterSpacing: 10 }}>{rankedParty.code}</p>
                    <button onClick={() => { try { navigator.clipboard.writeText(rankedParty.code); } catch {} }} style={{ marginTop: 10, background: 'rgba(255,140,0,0.18)', border: '1px solid rgba(255,140,0,0.3)', borderRadius: 8, color: '#FF8C00', fontWeight: 700, fontSize: 11, padding: '5px 14px', cursor: 'pointer' }}>ðŸ“‹ Copiar cÃ³digo</button>
                  </div>
                  <p style={{ margin: 0, fontSize: 12, color: 'rgba(255,255,255,0.35)', textAlign: 'center' }}>Plataforma: <strong style={{ color: '#fff' }}>{rankedParty.platform === 'switch' ? 'ðŸŽ® Switch' : 'ðŸ’» Parsec'}</strong></p>
                </>
              ) : (
                <p style={{ margin: 0, fontSize: 13, color: 'rgba(255,255,255,0.5)', textAlign: 'center' }}>Esperando que el lÃ­der comience la bÃºsqueda...</p>
              )}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div style={{ background: 'rgba(255,140,0,0.05)', border: '1px solid rgba(255,140,0,0.18)', borderRadius: 16, padding: '14px 16px' }}>
                <p style={{ margin: '0 0 10px', fontSize: 11, fontWeight: 700, color: 'rgba(255,140,0,0.7)', letterSpacing: '0.08em', textTransform: 'uppercase' }}>Tu equipo âœ…</p>
                {[rankedParty.leader, rankedParty.invited].map((p, idx) => p ? (
                  <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '6px 0', borderTop: idx > 0 ? '1px solid rgba(255,255,255,0.06)' : 'none' }}>
                    <div style={{ width: 32, height: 32, borderRadius: 8, background: 'rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 16 }}>ðŸ‘¤</div>
                    <div>
                      <p style={{ margin: 0, fontWeight: 800, fontSize: 14, color: '#fff' }}>{p.userName}</p>
                      <p style={{ margin: 0, fontSize: 11, color: 'rgba(255,255,255,0.35)' }}>{p.userId === uid ? '(vos)' : 'compaÃ±ero'}</p>
                    </div>
                  </div>
                ) : null)}
              </div>
      ...
      <div style={{ marginTop: 32, display: 'flex', flexDirection: 'column', gap: 8 }}>
        <p style={{ margin: '0 0 8px', fontSize: 10, fontWeight: 700, color: 'rgba(255,255,255,0.25)', textTransform: 'uppercase', letterSpacing: 1 }}>Â¿CÃ³mo funciona?</p>
        {matchTypeMode === 'casual' ? (
          [['ðŸŽ®','ElegÃ­ personaje','SeleccionÃ¡ con quiÃ©n querÃ©s jugar'],['ðŸ”','BuscÃ¡ rival','ElegÃ­ Switch o Parsec y entrÃ¡ a la cola Normal'],['âœ…','Ambos aceptan (15s)','Cuando se encuentre rival, los dos confirman'],['âš”ï¸','A jugar','Partida casual, sin efecto en el rango']].map(([icon,t,d])=>(
          ...
          [['ðŸŽ®','ElegÃ­ personaje','SeleccionÃ¡ con quiÃ©n querÃ©s jugar'],['ðŸ”','BuscÃ¡ rival','ElegÃ­ Switch o Parsec y entrÃ¡ a la cola'],['âœ…','Ambos aceptan (15s)','Cuando se encuentre rival, los dos confirman'],['ðŸ’¬','CoordinÃ¡ en el chat','Decidan quiÃ©n crea la sala/hostea'],['âš”ï¸','A jugar','Escenario aleatorio, reportan resultado al final']].map(([icon,t,d])=>(
            <div key={t} style={{ display: 'flex', gap: 12, alignItems: 'flex-start', padding: '4px 0' }}>
              <span style={{ fontSize: 16, flexShrink: 0, marginTop: 1 }}>{icon}</span>
              <div>
                <p style={{ margin: '0 0 1px', fontSize: 13, fontWeight: 700, color: 'rgba(255,255,255,0.8)' }}>{t}</p>
          ...
          [['ðŸ‘¥','InvitÃ¡ a un amigo','Desde tu perfil, tocÃ¡ ðŸ’¬ y usÃ¡ el botÃ³n 2v2'],['âœ…','Tu amigo acepta','Cuando acepte, el party estarÃ¡ listo'],['ðŸ”','Buscar rivales','EntrÃ¡ a la cola como equipo de 2'],['âš”ï¸','Los 4 aceptan','Ambos equipos confirman la partida'],['ðŸ†','ReportÃ¡ el resultado','El equipo ganador reporta y sube de rango']].map(([icon,t,d])=>(
            <div key={t} style={{ display: 'flex', gap: 12, alignItems: 'flex-start', padding: '4px 0' }}>
              <span style={{ fontSize: 16, flexShrink: 0, marginTop: 1 }}>{icon}</span>
              <div>
                <p style={{ margin: '0 0 1px', fontSize: 13, fontWeight: 700, color: 'rgba(255,255,255,0.8)' }}>{t}</p>
