...
export const PLACEMENT_MATCHES = 10;   // partidas de clasificación
...
// ═══════════════════════════════════════════════════════════════════
export function processMatchResult(winnerStats, loserStats) {
